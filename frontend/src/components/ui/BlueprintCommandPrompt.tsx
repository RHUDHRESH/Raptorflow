...
export function BlueprintCommandPrompt() {
    ...
    const commands: CommandItem[] = [
        ...
        // Actions
        { id: "act-create-move", icon: <Zap size={14} />, label: "Create New Move", description: "Start a tactical move", group: "Actions", action: () => router.push("/moves/new") },
        { id: "act-draft-content", icon: <FileText size={14} />, label: "Draft Content", description: "Open Muse writer", group: "Actions", action: () => router.push("/muse?intent=draft") },

        // System
        { id: "sys-theme", icon: <Settings size={14} />, label: "Toggle Theme", group: "System", action: () => { } },
    ];
