...
import { X, ChevronDown, ChevronUp, MessageSquare, Target, Volume2, BookOpen, CheckCircle2, AlertCircle } from "lucide-react";
import { cn } from "@/lib/utils";
import { CoreMessaging } from "@/types/foundation";

/* ══════════════════════════════════════════════════════════════════════════════
   MESSAGING DETAIL MODAL — Core Messaging & StoryBrand Framework
                            ...
                            >
                                <div className="flex flex-wrap gap-2">
                                    {messaging.storyBrand.avoidFailure.map((item, i) => (
                                        <span key={i} className="px-3 py-1.5 bg-red-100 text-red-700 text-sm rounded-lg">
                                            ⚠️ {item}
                                        </span>
                                    ))}
                                </div>
                            ...
                            >
                                <div className="flex flex-wrap gap-2">
                                    {messaging.storyBrand.success.map((item, i) => (
                                        <span key={i} className="px-3 py-1.5 bg-green-100 text-green-700 text-sm rounded-lg">
                                            ✨ {item}
                                        </span>
                                    ))}
                                </div>
