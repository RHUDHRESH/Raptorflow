-- =================================================================
-- COMPLETE SECURITY FIXES - BASED ON ACTUAL SCHEMA
...
-- Keep existing handle_new_user function but fix search_path if it exists
DO $$
BEGIN
...
-- icp_disqualifiers policies - using workspace_id from icp_profiles
