...
-- This will fix ALL database issues systematically
...
-- STEP 2: Fix workspaces table (add missing owner_id if needed)
DO $$
BEGIN
...
-- STEP 3: Create profiles table with all required fields
...
-- STEP 4: Create BCM manifest table
...
-- STEP 5: Create foundations table
...
-- STEP 6: Create comprehensive ICP tables
...
-- STEP 11: Update migration records
