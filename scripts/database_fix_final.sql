...
-- Handles all issues including vector extension
...
-- STEP 2: Clean up any existing problematic tables
...
-- STEP 3: Check and fix workspaces table structure
DO $$
BEGIN
...
-- STEP 5: Now add the foreign key constraint to workspaces
ALTER TABLE public.workspaces ADD CONSTRAINT fk_workspaces_owner 
    FOREIGN KEY (owner_id) REFERENCES public.profiles(id) ON DELETE CASCADE;

-- STEP 6: Create BCM manifest table
...
-- STEP 7: Create foundations table
...
-- STEP 8: Create comprehensive ICP tables
...
-- STEP 13: Update migration records
TRUNCATE TABLE supabase_migrations.schema_migrations RESTART IDENTITY;

INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES
('001_profiles', '001_profiles.sql'),
('002_workspaces', '002_workspaces.sql'),
('20240102_foundations', '20240102_foundations.sql'),
('20240103_icp_profiles', '20240103_icp_profiles.sql'),
('20260116_bcm_manifest', '20260116_bcm_manifest.sql');
