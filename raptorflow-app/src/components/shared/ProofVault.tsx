...
const proofTypes = [
  { value: 'testimonial', label: 'Testimonial', icon: MessageSquare, color: 'bg-blue-100 text-blue-700' },
  { value: 'case_study', label: 'Case Study', icon: FileText, color: 'bg-green-100 text-green-700' },
  { value: 'metric', label: 'Metric/Number', icon: BarChart3, color: 'bg-purple-100 text-purple-700' },
  { value: 'logo', label: 'Client Logo', icon: Users, color: 'bg-orange-100 text-orange-700' },
  { value: 'screenshot', label: 'Screenshot', icon: Image, color: 'bg-pink-100 text-pink-700' },
...
export function ProofVault({ items, onAddItem, onUpdateItem, onDeleteItem, currentPhase }: ProofVaultProps) {
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={() => editingItem && handleUpdate(editingItem)}>
                  Save Changes
                </Button>
              </div>
            </div>
