      ...
      <div className="flex flex-wrap gap-2">
        {tools.map((tool) => {
          ...
          const isVerified = [
            ...
            'Perplexity',
            'Tavily',
          ].includes(tool); // Mock verification
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-[11px] font-bold text-zinc-900 dark:text-zinc-100 leading-none mb-0.5">
                  {tool}
                </span>
                <div className="flex items-center gap-1">
                  {isVerified ? (
                    <>
                      ...
                      <span className="text-[8px] font-bold uppercase text-emerald-600/70">
                        Verified
                      </span>
                    </>
                  ) : (
