...
export function CaptionSuggestions({
    ...
    const [filter, setFilter] = useState<CaptionSuggestion['style'] | 'all'>('all');
    ...
    const filteredCaptions = filter === 'all'
        ? captions
        : captions.filter(c => c.style === filter);
    ...
    return (
        <div className={cn('space-y-4', className)}>
            ...
            <div className="flex items-center gap-1 flex-wrap">
                ...
                {(['funny', 'relatable', 'provocative', 'informative'] as const).map(style => (
                    <button
                        key={style}
                ...
                {filteredCaptions.map(caption => (
                    ...
                    >
                        <div className="flex items-start gap-3">
                            <span className="text-lg shrink-0">{STYLE_ICONS[caption.style]}</span>
                                    ...
                                    {caption.score && (
                                        <>
                                            ...
                                            <span className={cn(
                                                ...
                                                caption.score >= 50 && caption.score < 75 && 'text-amber-500',
