...
export function ToneSlider({ value = 50, onChange, className }: ToneSliderProps) {
                ...
                {TONE_STOPS.map((stop) => (
                    <button
                        ...
                        className={cn(
                            ...
                            Math.abs(localValue - stop.value) <= 12 ? 'opacity-100' : 'opacity-40 hover:opacity-70'
                        )}
                    >
                        <div className={cn(
...
export function ToneSliderCompact({ value = 50, onChange, className }: ToneSliderProps) {
    const [localValue, setLocalValue] = useState(value);
    const currentTone = getToneForValue(localValue);
