...
export const ASSET_TYPES: AssetTypeConfig[] = [
  // Text-based assets
  {
    ...
    label: 'Email',
    category: 'text',
    description: 'General email copy',
    icon: 'Mail',
  },
  {
    type: 'sales-email',
    label: 'Sales Email',
    category: 'text',
    description: 'Cold outreach or follow-up',
    icon: 'Send',
  },
  {
    type: 'nurture-email',
    label: 'Nurture Email',
    category: 'text',
    description: 'Relationship building sequence',
    icon: 'Heart',
  },
  {
    type: 'tagline',
  ...
  },
  {
    ...
    label: 'Product Name',
    category: 'strategy',
    description: 'Name ideas for products',
    icon: 'Lightbulb',
  },
  {
    type: 'lead-gen-pdf',
    label: 'Lead Gen PDF',
    category: 'text',
    description: 'PDF content outline',
    icon: 'FileText',
  },
  {
    ...
    category: 'text',
    description: 'Key points for sales calls',
    icon: 'Mic',
  },
  // Visual assets
  {
  ...
  },
  {
    ...
    label: 'Social Card',
    category: 'visual',
    description: 'Visual post for feeds',
    icon: 'Layout',
  },
];
