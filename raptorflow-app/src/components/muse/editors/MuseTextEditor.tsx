...
const AI_ACTIONS = [
  ...
  },
  {
    ...
    icon: Sparkles,
    description: 'Make it sound formal',
  },
  {
    id: 'tone-casual',
    label: 'Casual Tone',
  ...
  const handleAIAction = async (actionId: string) => {
    ...
    if (textarea) {
      ...
      const newContent =
        ...
        transformed +
        content.substring(start + selectedText.length);
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-[#E5E6E3] bg-white">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-xs text-[#9D9F9F]">
              ...
              {firstLine && (
                <HookScoreBadge text={firstLine} className="ml-2" />
              )}
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-36 px-3">
            <ToneSliderCompact value={tone} onChange={(v) => setTone(v)} />
          </div>
        ...
        >
          <div className="w-80 h-full flex flex-col">
            ...
            <div className="flex-1 overflow-auto p-4">
                  ...
                  {selectedText ? (
                    ...
                    <div className="text-center py-12 px-6">
                      ...
                      <p className="text-sm font-medium mb-1">
                        Select text to surgicalize
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Choose any section to improve, shorten, or adjust tone.
                      </p>
                    </div>
                  )}
                </>
              ...
              {/* Hook Score Panel */}
              {activePanel === 'hook' && <HookScore text={firstLine} />}
            </div>
          </div>
        </div>
      </div>
