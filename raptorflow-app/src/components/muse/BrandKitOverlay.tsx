...
const CROP_PRESETS = [
    { id: 'square', label: 'Square', ratio: '1:1', width: 1080, height: 1080, platform: 'Instagram' },
    { id: 'landscape', label: 'Landscape', ratio: '16:9', width: 1920, height: 1080, platform: 'YouTube' },
    { id: 'portrait', label: 'Portrait', ratio: '4:5', width: 1080, height: 1350, platform: 'Instagram' },
    { id: 'stories', label: 'Stories', ratio: '9:16', width: 1080, height: 1920, platform: 'IG/TikTok' },
    { id: 'linkedin', label: 'LinkedIn', ratio: '1.91:1', width: 1200, height: 628, platform: 'LinkedIn' },
    { id: 'twitter', label: 'Twitter', ratio: '16:9', width: 1600, height: 900, platform: 'Twitter' },
];
    ...
    return (
        <div className={cn('space-y-4', className)}>
            ...
            <div className="space-y-2">
                <p className="text-xs text-muted-foreground uppercase tracking-wide">Colors</p>
                <div className="flex items-center gap-2">
                    <div
            ...
            {/* Font */}
            <div className="space-y-2">
                <p className="text-xs text-muted-foreground uppercase tracking-wide">Typography</p>
...
export function SmartCropPresets({ onSelect, selected, className }: SmartCropPresetsProps) {
    return (
