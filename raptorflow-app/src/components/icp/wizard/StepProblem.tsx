        ...
        <div className="space-y-12">
            <div className="text-center space-y-4">
                ...
                <p className="text-[#5B5F61] text-lg max-w-md mx-auto">
                    What is the <span className="font-semibold text-[#2D3538]">bleeding neck</span> problem?
                    Select max 2. If everything is a problem, nothing is.
                </p>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  ${isSelected
                            ...
                            >
                                <div className={`w-5 h-5 rounded-full border mr-4 flex items-center justify-center transition-colors
                  ${isSelected ? 'border-[#2D3538] bg-[#2D3538]' : 'border-[#9D9F9F]'}`}>
                                    {isSelected && <div className="w-1.5 h-1.5 rounded-full bg-white" />}
                                </div>
                                <span className={`font-medium text-lg ${isSelected ? 'text-[#2D3538]' : 'text-[#5B5F61]'}`}>
                                    {problem}
                                </span>
                            </button>
                        );
            ...
            <div className="space-y-4 pt-8 border-t border-[#C0C1BE]/30">
                ...
                <p className="text-sm text-[#5B5F61] mb-4">What happens right before they buy?</p>
