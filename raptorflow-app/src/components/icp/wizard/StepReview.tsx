...
export default function StepReview({ data, onChange, onJumpToStep }: StepReviewProps) {
    ...
    return (
        <div className="space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs text-[#2D3538] opacity-0 group-hover:opacity-100 transition-opacity">Edit</span>
                        </div>
                    ...
                    {data.disqualifiers && (
                        ...
                        >
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-xs text-red-800 opacity-0 group-hover:opacity-100 transition-opacity">Edit</span>
                            </div>
                            <div className="flex flex-wrap gap-2">
            ...
            <ShareExportModal isOpen={showShareModal} onClose={() => setShowShareModal(false)} data={data} />
        </div>
    );
}
