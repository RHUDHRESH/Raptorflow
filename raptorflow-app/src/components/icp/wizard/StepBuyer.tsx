...
export default function StepBuyer({
  firmographics,
  painMap,
  onChangeFirmographics,
  onChangePainMap,
}: StepBuyerProps) {
        ...
        <div className="grid grid-cols-3 gap-4">
          {URGENCY_LEVELS.map((u) => (
            ...
            >
              ...
              <div
                className={`text-xs mt-1 ${painMap.urgencyLevel === u.value ? 'text-gray-300' : 'text-[#9D9F9F]'}`}
              >
                {u.desc}
              </div>
            </button>
