      ...
      <div className="flex justify-between items-start">
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent
              side="left"
              className="max-w-[200px] bg-[#2D3538] text-white border-none p-3 text-[11px]"
            >
              <p>
    ...
    <div className="space-y-10 py-4">
      ...
      <div className="bg-[#F3F4EE] border border-[#C0C1BE] p-6 rounded-xl flex gap-4 items-center">
        ...
        <p className="text-[12px] text-[#5B5F61] leading-relaxed italic">
          The Matrix ensures you never speak to a 'Most-Aware' prospect with
          'Unaware' messaging.
          <span className="font-semibold text-[#2D3538]">
            {' '}
            Precision is surgical resonance.
          </span>
        </p>
      </div>
    </div>
