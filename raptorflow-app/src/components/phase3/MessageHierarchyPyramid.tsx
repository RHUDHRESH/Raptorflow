...
export function MessageHierarchyPyramid({ essence, coreMessage, pillars, onChange }: MessageHierarchyPyramidProps) {
    const addPillar = () => {
        if (pillars.length < 5) {
            onChange('pillars', [...pillars, { title: '', description: '', proofPoints: [] }]);
        }
    };
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="relative w-full max-w-2xl aspect-[4/3] flex flex-col items-center justify-between pointer-events-none mb-12">
                    <div className="absolute inset-0 flex items-center justify-center opacity-[0.03]">
                        <Triangle className="w-full h-full fill-[#2D3538]" strokeWidth={0.5} />
                    </div>

                    {/* Level 1: Essence */}
                    <div className="w-[30%] h-24 border-b border-[#C0C1BE] flex flex-col items-center justify-center text-center px-4 relative z-10">
                        <span className="text-[10px] font-mono uppercase tracking-[0.2em] opacity-40 mb-1">Level 01</span>
                        <span className="font-serif italic text-lg opacity-80">Essence</span>
                    </div>
                    ...
                    <div className="w-[60%] h-24 border-b border-[#C0C1BE] flex flex-col items-center justify-center text-center px-8 relative z-10">
                        <span className="text-[10px] font-mono uppercase tracking-[0.2em] opacity-40 mb-1">Level 02</span>
                        <span className="font-serif italic text-xl opacity-80">Core Message</span>
                    </div>

                    {/* Level 3: Pillars */}
                    <div className="w-full h-24 flex items-center justify-center gap-4 text-center px-12 relative z-10">
                        <div className="flex flex-col items-center">
                            <span className="text-[10px] font-mono uppercase tracking-[0.2em] opacity-40 mb-1">Level 03</span>
                            <span className="font-serif italic text-lg opacity-80">Supporting Pillars</span>
                        </div>
                    </div>
                </div>
