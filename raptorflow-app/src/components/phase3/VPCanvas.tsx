...
function PainGainCard({
    ...
    const severity = 'severity' in item ? item.severity : (item as VPCGain).importance;
                        ...
                        {Array.from({ length: 5 }).map((_, i) => (
                            <div
                                ...
                                className={cn(
                                    ...
                                    i < severity
                                        ? (type === 'pain' ? 'bg-red-500' : 'bg-green-500')
                                        : 'bg-muted'
                                )}
                            />
                        ))}
...
export function VPCanvas({ vpc, onChange, onContinue }: VPCanvasProps) {
    const removePain = (id: string) => {
        onChange({
            ...
            valueMap: {
                ...vpc.valueMap,
                painRelievers: vpc.valueMap.painRelievers.filter(r => r.painId !== id)
            }
        });
    };
        ...
        <div className="space-y-8">
            ...
            <div className="text-center space-y-2">
                ...
                <p className="text-muted-foreground max-w-lg mx-auto">
                    The left side is your customer. The right side is your solution. Lines show the fit.
                </p>
            </div>
            ...
            <div className="max-w-2xl mx-auto bg-card border rounded-xl p-4">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={cn(
                        "text-sm font-bold",
                        vpc.fitCoverage.score >= 70 ? "text-green-600" :
                            vpc.fitCoverage.score >= 40 ? "text-amber-600" : "text-red-600"
                    )}>
                ...
                <div className="h-2 bg-muted rounded-full overflow-hidden">
                    <div
                        className={cn(
                            ...
                            vpc.fitCoverage.score >= 70 ? "bg-green-500" :
                                vpc.fitCoverage.score >= 40 ? "bg-amber-500" : "bg-red-500"
                        )}
            ...
            <div className="grid grid-cols-2 gap-6 max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                        <h3 className="text-sm font-medium text-red-600 dark:text-red-400">Pains</h3>
                    ...
                    {/* Gains */}
                    <div className="space-y-3">
                        <h3 className="text-sm font-medium text-green-600 dark:text-green-400">Gains</h3>
                ...
                <div className="space-y-6">
                    ...
                    {/* Pain Relievers */}
                    <div className="space-y-3">
                        <h3 className="text-sm font-medium text-orange-600 dark:text-orange-400">Pain Relievers</h3>
                    ...
                    {/* Gain Creators */}
                    <div className="space-y-3">
                        <h3 className="text-sm font-medium text-teal-600 dark:text-teal-400">Gain Creators</h3>
