      ...
      >
        ...
        <header
          className={cn(
            ...
            fullBleed &&
              'bg-background/80 dark:bg-background/80 border-transparent'
          )}
        >
          <div className="flex items-center gap-4 px-4 w-full">
            ...
            <div className="flex items-center gap-1">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-48 rounded-xl dark:bg-[#141618] dark:border-[#1e2326]"
                >
                  <DropdownMenuItem
                    className="cursor-pointer rounded-lg dark:focus:bg-[#E9ECE6]/[0.05]"
                    onClick={() =>
                      window.dispatchEvent(new CustomEvent('rf:new-move'))
                    }
                  >
                    <span className="text-[13px]">New Move</span>
                    <span className="ml-auto text-[10px] text-gray-400 dark:text-[#5a6268]">
                      ⌘M
                    </span>
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    className="cursor-pointer rounded-lg dark:focus:bg-[#E9ECE6]/[0.05]"
                    onClick={() =>
                      window.dispatchEvent(new CustomEvent('rf:new-campaign'))
                    }
                  >
