  ...
  return (
    ...
    >
      <SidebarHeader className="h-14 flex items-center justify-center px-4 mb-2 pt-4">
        <Link
          href="/"
          className="block group-data-[collapsible=icon]:hidden w-full flex justify-center"
        >
          <Image
              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  <Avatar className="h-7 w-7 rounded-md border border-sidebar-border/30">
                    ...
                    <AvatarFallback className="rounded-md bg-sidebar-accent font-medium text-xs">
                      FD
                    </AvatarFallback>
                  </Avatar>
