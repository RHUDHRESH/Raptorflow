...
export function Phase1Point5Wizard() {
    ...
    const phase1Point5Questions: Question[] = [...outcomesQuestions, ...offerQuestions];
    ...
    const currentSectionName = outcomesQuestions.find(q => q.id === currentQuestion?.id) ? 'Outcomes' : 'Offer';
    ...
    }, [currentLocalIndex, phase1Point5Questions.length, router, currentQuestion, hasValue]);
            ...
            <div className={styles.leftPanel}>
                <div className="w-full h-full flex flex-col">
                    ...
                    <div className={styles.sectionInfo}>
                        ...
                        <p className={styles.sectionDescription}>Defining what you sell and why it matters.</p>
                    </div>
                ...
                <div className={styles.panelContent}>
                    ...
                    >
                        <div className={styles.questionHeader}>
                            <span ref={questionNumberRef} className={styles.qNumber}>Question {currentLocalIndex + 1} of {phase1Point5Questions.length}</span>
