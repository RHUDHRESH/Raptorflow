...
export function Phase2Wizard() {
    ...
    }, [currentLocalIndex, phase2Questions.length, currentQuestion, hasValue, handleComplete]);
            ...
            <div className={styles.leftPanel}>
                <div className="w-full h-full flex flex-col">
                    ...
                    <div className={styles.sectionInfo}>
                        ...
                        <p className={styles.sectionDescription}>Who uses it, who buys it.</p>
                    </div>
                ...
                <div className={styles.panelContent}>
                    ...
                    >
                        <div className={styles.questionHeader}>
                            <span ref={questionNumberRef} className={styles.qNumber}>Question {currentLocalIndex + 1} of {phase2Questions.length}</span>
