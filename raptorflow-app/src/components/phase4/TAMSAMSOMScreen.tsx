...
export function TAMSAMSOMScreen({
  data,
  onChange,
  onContinue,
}: TAMSAMSOMScreenProps) {
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto">
          Market sizing tied to your category and segment choices. All
      ...
      <div className="max-w-md mx-auto text-center">
        <div className="relative h-48">
          ...
          {/* Labels */}
          <div className="absolute right-0 top-3 text-xs text-blue-700 dark:text-blue-400">
            TAM
          </div>
          <div className="absolute right-0 top-[60px] text-xs text-purple-700 dark:text-purple-400">
            SAM
          </div>
          <div className="absolute right-0 top-[108px] text-xs text-green-700 dark:text-green-400">
            SOM
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-xs text-muted-foreground mt-2">
          When category changes → TAM changes. When segment changes → SAM
          changes.
        </p>
      </div>
