...
export function ResearchWhiteboard({
  pains,
  onChange,
}: ResearchWhiteboardProps) {
  ...
  const categories = [
    {
      id: 'functional',
      label: 'Functional Pains',
      icon: <Move className="w-4 h-4" />,
    },
    {
      id: 'emotional',
      label: 'Emotional Pains',
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-8">
                <h4 className={`${playfair.className} text-2xl`}>
                  Add Research Note
                </h4>
                <button
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex gap-2">
                    {categories.map((c) => (
                      <button
                        key={c.id}
                        onClick={() =>
                          setNewPain({ ...newPain, category: c.id as any })
                        }
                        className={cn(
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    value={newPain.text}
                    onChange={(e) =>
                      setNewPain({ ...newPain, text: e.target.value })
                    }
