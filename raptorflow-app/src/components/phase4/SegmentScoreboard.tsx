  ...
  return (
    <div
      className={cn(
        ...
        segment.isExcluded
          ? 'opacity-50 border-dashed border-muted'
          : segment.isPrimary
    ...
    >
      ...
      <div className="space-y-2 mb-4">
        ...
        <ScoreBar
          label="Budget"
          value={segment.scores.budget}
          color="bg-green-500"
        />
        <ScoreBar
          label="Triggers"
          value={segment.scores.triggers}
          color="bg-blue-500"
        />
        <ScoreBar
          label="Switch"
          value={segment.scores.switching}
          color="bg-purple-500"
        />
        <ScoreBar
          label="Proof"
          value={segment.scores.proofFit}
          color="bg-amber-500"
        />
      </div>
      ...
      <div className="flex gap-2">
        ...
        <Button
          ...
          className={
            segment.isExcluded ? 'text-green-600' : 'text-muted-foreground'
          }
        >
          {segment.isExcluded ? (
            <>Include</>
...
export function SegmentScoreboard({
  segments,
  onChange,
  onContinue,
}: SegmentScoreboardProps) {
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto">
          You can't be for everyone. Pick ONE primary segment. This is Dunford
          Component #4.
        </p>
      </div>
