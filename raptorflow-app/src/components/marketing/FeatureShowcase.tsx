...
const features: Feature[] = [
  {
    ...
    description:
      'Transform messy context into crystal-clear positioning that actually resonates.',
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      'Strategic campaigns that build on each other instead of random tactics.',
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    title: 'Weekly Moves',
    description:
      'Ship concrete marketing assets every week that drive real revenue.',
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">
            Built for founders who are tired of guessing and want a system that
            compounds.
          </p>
        </motion.div>
