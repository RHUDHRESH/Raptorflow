    ...
    useEffect(() => {
        const updatePositions = () => {
            ...
            modules.forEach((module) => {
                const element = containerRef.current?.querySelector(`[data-module-id="${module.id}"]`);
                if (element) {
        ...
        >
            {connectionPairs.map(([fromId, toId]) => {
                ...
                const isHighlighted = hoveredModule
                    ...
                    hoveredModule === toId ||
                    modules.find((m) => m.id === hoveredModule)?.connections.includes(fromId) ||
                    modules.find((m) => m.id === hoveredModule)?.connections.includes(toId)
                    : false;
                ...
                return (
                    <line
                        ...
                        className={`transition-opacity duration-300 ${isHighlighted ? 'opacity-25' : 'opacity-[0.06]'
                            }`}
                    />
                );
            })}
        ...
        <section id="features" className="py-24 lg:py-32" ref={sectionRef}>
          ...
          `}
                ...
                <div className="relative" ref={containerRef}>
                    {/* Connection Lines */}
                    <ConnectionLines hoveredModule={hoveredModule} containerRef={containerRef} />
