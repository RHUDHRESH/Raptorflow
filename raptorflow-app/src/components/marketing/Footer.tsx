...
const footerSections = {
    ...
    features: {
        title: 'Features',
        links: [
            { label: 'Foundation', href: '/features/foundation' },
            { label: 'Cohorts', href: '/features/cohorts' },
            { label: 'Moves', href: '/features/moves' },
            { label: 'Campaigns', href: '/features/campaigns' },
            { label: 'Muse', href: '/features/muse' },
            { label: 'Matrix', href: '/features/matrix' },
            { label: 'Blackbox', href: '/features/blackbox' },
            { label: 'Radar', href: '/features/radar' },
        ],
    },
    company: {
        title: 'Company',
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                    ...
                    <div className="col-span-2 md:col-span-3 lg:col-span-1">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                            Turn chaos into campaigns. The marketing operating system for founders who refuse to guess.
                        </p>
                        {/* Social Links */}
