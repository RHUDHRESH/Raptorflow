...
function getDiagnosis(score: number): DiagnosisResult {
  if (score <= 25) {
    return {
      ...
      description:
        'You are already running a tight operation. RaptorFlow can help you scale faster.',
      painPoints: ['Scaling without losing quality', 'Team coordination'],
      solutions: [
        {
          feature: 'Muse',
          benefit: '10x content output without losing your voice',
        },
    ...
    return {
      ...
      description:
        'You have systems, but gaps are showing. Time to close them before they widen.',
      painPoints: [
      ...
      solutions: [
        {
          feature: 'Foundation',
          benefit: 'Lock in your positioning once and for all',
        },
        {
          feature: 'Campaigns',
          benefit: '90-day arcs that compound instead of reset',
        },
        {
          feature: 'Moves',
          benefit: 'Weekly execution packets you can actually ship',
        },
      ],
    };
  } else if (score <= 75) {
    return {
      ...
      description:
        'You are stuck in the classic founder trap: too busy building to market consistently.',
      painPoints: [
      ...
      solutions: [
        {
          feature: 'Foundation',
          benefit: 'Extract strategy from your head in 10 minutes',
        },
    ...
    return {
      ...
      description:
        'You are losing customers to competitors with worse products but clearer messaging.',
      painPoints: [
        'Complete chaos',
        'No system',
    ...
    return (
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h3 className="font-display text-2xl font-medium mt-6">
            {diagnosis.title}
          </h3>
