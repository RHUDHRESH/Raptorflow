...
const nodes: FlowNode[] = [
    { id: 'foundation', label: 'Foundation', x: 15, y: 50, description: 'Your BrandKit & positioning' },
    { id: 'cohorts', label: 'Cohorts', x: 30, y: 30, description: 'ICP & segmentation' },
    { id: 'campaigns', label: 'Campaigns', x: 45, y: 50, description: '90-day strategic arcs' },
    { id: 'moves', label: 'Moves', x: 60, y: 30, description: 'Weekly execution' },
    { id: 'muse', label: 'Muse', x: 60, y: 70, description: 'AI content factory' },
    { id: 'matrix', label: 'Matrix', x: 75, y: 50, description: 'Command center' },
    { id: 'blackbox', label: 'Blackbox', x: 90, y: 30, description: 'A/B experiments' },
    { id: 'radar', label: 'Radar', x: 90, y: 70, description: 'Competitor intel' },
];
    ...
    return (
        ...
        >
            ...
            `}
              ...
              `}
                        >
                            <div className="font-semibold text-sm whitespace-nowrap">{node.label}</div>
                            {isHovered && (
            ...
            <div className="absolute bottom-4 right-4 text-xs text-muted-foreground">
                <span className="px-2 py-1 rounded bg-muted">Feedback Loop: Learn → Improve</span>
            </div>
        </div>
    );
}
