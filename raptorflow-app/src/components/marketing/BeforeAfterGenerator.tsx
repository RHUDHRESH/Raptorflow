            ...
            <div className="w-full max-w-4xl mx-auto">
                ...
                <div className="rounded-2xl border border-border overflow-hidden">
                    <div className="grid grid-cols-3 bg-muted/50">
                        ...
                        <div className="p-4 text-sm font-medium text-center text-destructive/80">Before</div>
                        <div className="p-4 text-sm font-medium text-center text-green-600">After 90 Days</div>
                    </div>
                ...
                <div className="mt-8 relative">
                    ...
                    <div className="relative flex items-center justify-between">
                        ...
                        <div className="w-1/3 pr-8 text-right">
                            ...
                            <div className="text-xs text-muted-foreground">Start your Foundation</div>
                        </div>
                    ...
                    <div className="relative flex items-center justify-between">
                        <div className="w-1/3 pr-8 text-right">
                            ...
                            <div className="text-xs text-muted-foreground">First Moves shipped</div>
                        </div>
                    ...
                    <div className="relative flex items-center justify-between">
                        <div className="w-1/3 pr-8 text-right">
                            ...
                            <div className="text-xs text-muted-foreground">Campaign complete</div>
                        </div>
                        <div className="absolute left-1/2 -translate-x-1/2 h-4 w-4 rounded-full bg-green-600" />
                        <div className="w-1/3 pl-8">
                            <div className="text-sm font-medium text-green-600">90+ pieces, system running</div>
                        </div>
                    </div>
                </div>
