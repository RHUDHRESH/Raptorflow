...
export function FoundationStudioHero() {
  ...
  const particles = Array.from({ length: 25 }).map((_, i) => {
    ...
    const duration =
      10 + (((seed * 9301 + 49297 + 4000) % 233280) / 233280) * 15;
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-8 text-center">
        ...
        >
          The Founder Marketing Operating System that converts business chaos
          into strategic clarity, systematic execution, and measurable growth.
        </p>
