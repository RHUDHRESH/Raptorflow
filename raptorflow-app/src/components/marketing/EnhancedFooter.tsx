        ...
        >
          <div className="max-w-md">
            ...
            <p className="text-muted-foreground mb-6">
              Get weekly insights on founder-led marketing.
            </p>
            <form className="flex gap-2">
              <input
                type="email"
                placeholder="Your email"
                className="flex-1 px-4 py-2 rounded-lg border border-border bg-background focus:outline-none focus:ring-2 focus:ring-foreground/20"
              />
              <button
                type="submit"
