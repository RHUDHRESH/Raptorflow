    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background: 'radial-gradient(circle, hsl(var(--muted-foreground) / 0.15) 0%, transparent 70%)',
                    filter: 'blur(60px)',
                }}
            />
...
export function GradientLine({
    ...
    useEffect(() => {
        ...
        if (prefersReducedMotion) {
            gsap.set(line, { scaleX: direction === 'horizontal' ? 1 : undefined, scaleY: direction === 'vertical' ? 1 : undefined });
            return;
        }
