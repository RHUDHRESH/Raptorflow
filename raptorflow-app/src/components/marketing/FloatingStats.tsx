...
export function FloatingStats() {
    ...
    return (
        <section ref={sectionRef} className="py-32 lg:py-40 bg-muted/30 relative overflow-hidden">
            {/* Subtle background pattern */}
            <div className="absolute inset-0 opacity-[0.02]">
                <svg className="w-full h-full">
                    <defs>
                        <pattern id="stats-grid" width="80" height="80" patternUnits="userSpaceOnUse">
