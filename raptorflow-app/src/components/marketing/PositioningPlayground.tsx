...
function generatePositioning(input: string): DemoResult {
  ...
  const hasClarity =
    lowerInput.includes('confus') ||
    lowerInput.includes('unclear') ||
    lowerInput.includes('messy');
  ...
  if (isSaas) {
    positioning =
      'The command center for SaaS founders who ship products but struggle to ship marketing. Turn technical excellence into market dominance.';
    tagline = 'Build products. Ship marketing. Scale faster.';
    icpTitle = 'Technical Founder / Product-First CEO';
    painPoints = [
      'Great product, weak positioning',
      'Know how to code but not how to communicate value',
      'Random content that does not convert',
    ];
    moves = [
    ...
    positioning =
      'The growth engine for boutique agencies drowning in client work but starving for their own leads. Practice what you preach.';
    tagline = 'Serve clients. Market yourself. Grow predictably.';
    icpTitle = 'Agency Owner / Consulting Partner';
    painPoints = [
      'Too busy with deliverables to market yourself',
      'Feast-or-famine pipeline',
      'No time for your own content',
    ];
    moves = [
    ...
    positioning =
      'The marketing hub for DTC brands competing on story, not just price. Turn products into movements.';
    ...
    positioning =
      'The marketing system for B2B founders selling to buyers who need to be educated, not entertained. Complex sales made simple.';
    tagline = 'Educate buyers. Close deals. Build pipeline.';
    icpTitle = 'B2B Founder / Enterprise Sales Leader';
    painPoints = [
      'Long sales cycles with no content support',
      'Complex product hard to explain',
      'Sales team has no marketing air cover',
    ];
    moves = [
    ...
    // Generic
    positioning =
      'The marketing operating system for founders who know their product is great but struggle to communicate why anyone should care.';
