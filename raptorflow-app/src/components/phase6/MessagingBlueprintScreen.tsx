...
export function MessagingBlueprintScreen({
  blueprint,
  onChange,
  onContinue,
}: MessagingBlueprintScreenProps) {
  const handlePillarUpdate = (
    pillerId: string,
    updatedPillar: MessagingPillar
  ) => {
    onChange({
      ...blueprint,
      pillars: blueprint.pillars.map((p) =>
        p.id === pillerId ? updatedPillar : p
      ),
    });
  };
    ...
    <div className="space-y-8">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Textarea
          ...
          onChange={(e) =>
            onChange({ ...blueprint, controllingIdea: e.target.value })
          }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Textarea
          ...
          onChange={(e) =>
            onChange({ ...blueprint, coreMessage: e.target.value })
          }
      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-4">
          ...
          <span
            className={cn(
              'text-sm font-medium',
              provenCount === blueprint.pillars.length
                ? 'text-green-600'
                : 'text-amber-600'
            )}
          >
