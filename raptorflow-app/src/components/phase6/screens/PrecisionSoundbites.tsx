...
export function PrecisionSoundbites({
  soundbites,
  onRegenerate,
  onUpdate,
}: Props) {
            ...
            <div className="flex items-start gap-4 p-6">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span
                    className={`px-2 py-0.5 rounded-full text-[10px] font-medium ${AWARENESS_BADGES[sb.awarenessStage]}`}
                  >
                    {sb.awarenessStage}
                  </span>
                </div>

                <p className="text-[#2D3538] font-medium mb-3">"{sb.text}"</p>
              ...
              <div className="p-6 border-t border-[#E5E6E3] bg-[#FAFAF8] space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={sb.punchLevel}
                    onChange={(e) =>
                      updatePunchLevel(sb.id, parseInt(e.target.value))
                    }
                  ...
                  <div className="grid grid-cols-5 gap-2">
                    {[
                      ...
                      <div key={score.label} className="text-center">
                        <div
                          className={`text-lg font-medium ${getScoreColor(score.value)}`}
                        >
                          {score.value}/5
                        </div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      {sb.vocAnchors.map((id) => (
                        <span
                          key={id}
                          className="px-2 py-1 bg-[#2D3538] text-white text-xs rounded-lg"
                        >
                          VoC #{id.slice(-4)}
                        </span>
                      ))}
