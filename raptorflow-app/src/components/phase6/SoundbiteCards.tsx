...
import { ArrowRight, Lock, Unlock, RefreshCw, Check, AlertTriangle, X } from 'lucide-react';
    ...
    return (
        <div className={cn(
            ...
            <div className="flex gap-2">
                <Button size="sm" variant="outline" onClick={onRegenerate} disabled={soundbite.isLocked}>
                    <RefreshCw className="h-3 w-3 mr-1" /> Regenerate
                </Button>
                <Button size="sm" variant={soundbite.isLocked ? "default" : "outline"} onClick={onToggleLock}>
                    {soundbite.isLocked ? <Unlock className="h-3 w-3 mr-1" /> : <Lock className="h-3 w-3 mr-1" />}
