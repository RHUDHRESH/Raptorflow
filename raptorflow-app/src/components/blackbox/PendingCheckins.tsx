...
export function PendingCheckins({ experiments, onReview }: PendingCheckinsProps) {
    if (experiments.length === 0) return null;

    return (
        <div className="flex flex-col gap-4">
            <h3 className="text-sm font-bold uppercase tracking-widest text-zinc-400 mb-2">Pending Check-ins</h3>
