...
export function ExperimentBuilder({
  ...
  const [selectedHeuristic, setSelectedHeuristic] =
    useState<HeuristicTemplate | null>(null);
    ...
    <div className="grid lg:grid-cols-12 gap-8 w-full max-w-6xl animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="lg:col-span-4 space-y-4">
        ...
        <div className="space-y-3 overflow-y-auto max-h-[600px] pr-2 custom-scrollbar">
          {HEURISTICS_LIBRARY.filter(
            (h) => !h.allowed_channels || h.allowed_channels.includes(channel)
          ).map((h) => (
            <Card
              key={h.id}
              className={cn(
                'cursor-pointer transition-all duration-300 border-stone-200 hover:border-stone-400 group',
                selectedHeuristic?.id === h.id
                  ? 'ring-2 ring-stone-800 border-stone-800 bg-stone-50'
                  : 'bg-white'
              )}
            ...
            >
              <CardContent className="p-4 space-y-2">
                <div className="flex justify-between items-start">
                  <h4 className="font-bold text-stone-800 group-hover:text-black transition-colors">
                    {h.title}
                  </h4>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-stone-500">
                  Construct your growth hypothesis with surgical precision
                </CardDescription>
              </div>
          ...
          <CardContent className="p-8 space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <Label className="text-sm font-semibold uppercase tracking-tight">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                <Input
                  placeholder={
                    selectedHeuristic?.control_placeholder ||
                    'Current behavior...'
                  }
              ...
              <div className="space-y-3">
                ...
                <Input
                  placeholder={
                    selectedHeuristic?.variant_placeholder || 'New behavior...'
                  }
                  className="rounded-xl border-stone-200"
                  value={variant}
