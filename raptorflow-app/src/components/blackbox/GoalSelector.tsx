...
import { MessageCircle, UserPlus, Calendar, MousePointer, Users, DollarSign, Star, TrendingUp, Eye, Heart, Share2, Zap } from 'lucide-react';
        ...
        <div className="w-full space-y-5 text-center">
            <div>
                ...
                <p className="text-sm text-zinc-500 font-sans">
                    Pick <span className="font-medium text-zinc-700 dark:text-zinc-300">1 primary</span> and up to <span className="font-medium text-zinc-700 dark:text-zinc-300">2 secondary</span> goals.
                </p>
                {selectedGoals && (
                ...
                {GOALS.map((g) => {
                    ...
                    return (
                        <button
                            ...
                            onDoubleClick={(e) => isSecondary ? handleSetAsPrimary(g.id, e) : undefined}
                            className={cn(
                                "relative flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all",
                                isPrimary && "bg-zinc-900 border-zinc-900 text-white dark:bg-white dark:border-white dark:text-zinc-900",
                                isSecondary && "bg-zinc-100 border-zinc-400 text-zinc-900 dark:bg-zinc-800 dark:border-zinc-600 dark:text-zinc-100 cursor-pointer",
                                !isPrimary && !isSecondary && "border-zinc-200 text-zinc-600 hover:border-zinc-400 dark:border-zinc-800 dark:text-zinc-400"
                            )}
                        >
            ...
            {selectedGoals && (
                <div className="text-xs text-zinc-500 font-sans">
                    <span className="font-medium text-zinc-700 dark:text-zinc-300">{selectedGoals.primary}</span>
