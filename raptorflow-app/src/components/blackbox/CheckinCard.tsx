...
import { CheckCircle2, XCircle, MinusCircle, ThumbsUp, ChevronDown } from 'lucide-react';
...
export function CheckinCard({ experiment, onSubmit, onCancel }: CheckinCardProps) {
    ...
    return (
        <div className="bg-white dark:bg-zinc-950 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800 max-w-md mx-auto overflow-hidden">
            ...
            <div className="p-5 border-b border-zinc-100 dark:border-zinc-900">
                <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 mb-1">Check-in</p>
                <h3 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">{experiment.title}</h3>
            </div>
            ...
            <div className="p-5 border-t border-zinc-100 dark:border-zinc-900 flex items-center justify-between">
                <Button variant="ghost" onClick={onCancel} className="rounded-lg text-zinc-500">
                    Cancel
                </Button>
                <Button
