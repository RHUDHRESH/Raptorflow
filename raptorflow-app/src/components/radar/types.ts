        ...
        sources: [
          {
            ...
            type: 'url',
            name: 'Pricing Page',
            value: 'https://competitor-a.com/pricing',
            health: 95,
          },
          {
            id: 'src-2',
            type: 'linkedin',
            name: 'Company Page',
            value: 'https://linkedin.com/company/competitor-a',
            health: 88,
          },
        ],
        ...
        sources: [
          {
            ...
            type: 'url',
            name: 'Blog',
            value: 'https://competitor-b.com/blog',
            health: 92,
          },
        ],
...
export const MOCK_ALERTS: Alert[] = [
  {
    ...
    summary:
      'Competitor A removed their "Starter" tier and increased Pro plan to $499/mo',
    details: [
    ...
    evidence: [
      {
        id: 'ev-1',
        type: 'screenshot',
        name: 'Pricing Page Snapshot',
        value: '/evidence/pricing-1.png',
        health: 100,
      },
    ],
  ...
  },
  {
    ...
    summary:
      'Competitor B is now positioning around "stop wasting resources" — a direct competitive hook',
    impact: 'medium',
    confidence: 'medium',
    evidence: [
      {
        ...
        type: 'linkedin',
        name: 'LinkedIn Post',
        value: 'https://linkedin.com/post/123',
        health: 100,
      },
    ],
...
export const MOCK_ANGLES: SignalAngle[] = [
  {
    ...
    label: 'Contrarian',
    type: 'contrarian',
    prompt: 'Write a contrarian take on this...',
  },
  {
    id: 'a2',
    label: 'Practical',
    type: 'practical',
    prompt: 'Give me actionable steps based on this...',
  },
  {
    id: 'a3',
    label: 'Founder Story',
    type: 'story',
    prompt: 'Turn this into a founder story...',
  },
  {
    id: 'a4',
    label: 'Data',
    type: 'data',
    prompt: 'Analyze the numbers here...',
  },
  {
    id: 'a5',
    label: 'Hot Take',
    type: 'hot-take',
    prompt: 'Give me a hot take on this...',
  },
  {
    id: 'a6',
    label: 'Meme',
    type: 'meme',
    prompt: 'Make a meme about this...',
  },
];
...
export const MOCK_SIGNALS: Signal[] = [
  {
    ...
    whyItMatters:
      'They are pivoting to enterprise. Your SMB moat is safe for now, but watch their pricing.',
