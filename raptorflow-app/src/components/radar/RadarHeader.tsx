      ...
      <div className="flex items-end justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button
            variant="outline"
            size="sm"
            className="h-9 gap-2 text-muted-foreground border-border hover:text-foreground"
          >
            <FilterIcon size={14} />
            Filters
          </Button>
          ...
          <Button
            ...
            disabled={isScanning}
            size="sm"
            className="ml-2 h-9 px-4 gap-2 text-sm font-medium shadow-sm"
          >
            <ZapIcon size={14} />
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="ml-2 h-9 px-4 gap-2 text-sm font-medium"
          >
            Generate Dossier
          </Button>
        </div>
