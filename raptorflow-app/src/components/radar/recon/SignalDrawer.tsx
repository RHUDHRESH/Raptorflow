        ...
        <div className="space-y-8">
          ...
          <div className="p-5 bg-secondary/30 rounded-xl border border-border/50">
            ...
            <p className="text-sm text-foreground/80 leading-relaxed">
              ...
              <br />
              <br />
              This signals a shift in market dynamics that directly affects
              their bottom line. Ignoring this would be a strategic blindspot.
            </p>
          </div>
          ...
          <div className="flex gap-3 pt-4">
            <Button
              className="flex-1"
              onClick={() => handleDraft(signal.angles[0]?.prompt)}
            >
              Draft in Muse
            </Button>
