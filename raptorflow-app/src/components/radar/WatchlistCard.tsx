...
export function WatchlistCard({ watchlist, onView, onEdit, onRunRecon }: WatchlistCardProps) {
    return (
            ...
            <div className="p-6">
                ...
                <div className="flex items-center gap-8 text-[13px] text-[#5B5F61] mb-5">
                    <div>
                        ...
                        <span className="text-[#2D3538] font-medium">{watchlist.competitors.length}</span>
                    </div>
                    <div>
                        <span className="text-[#9D9F9F]">Signals:</span>{' '}
                        <span className="text-[#2D3538] font-medium">{watchlist.signalTypes.join(', ')}</span>
                    </div>
                    <div>
                        <span className="text-[#9D9F9F]">Frequency:</span>{' '}
                        <span className="text-[#2D3538] font-medium capitalize">{watchlist.scanFrequency}</span>
                    </div>
                    <div>
                        <span className="text-[#9D9F9F]">Last Scan:</span>{' '}
                        <span className="text-[#2D3538] font-medium">{formatLastScan(watchlist.lastScan)}</span>
                    </div>
                </div>
