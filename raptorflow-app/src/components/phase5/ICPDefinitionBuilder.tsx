...
import {
    Building2, Users, MapPin, Wrench, Globe, DollarSign,
    ChevronDown, Plus, X, Check, FileText, Quote
} from 'lucide-react';
...
const INDUSTRY_OPTIONS = [
    ...
    'Media & Entertainment', 'Real Estate', 'Non-profit'
];
                ...
                <div>
                    ...
                    <div className="flex gap-2">
                        ...
                        >
                            ...
                            {INDUSTRY_OPTIONS.filter(i => !icp.firmographics.industries.includes(i)).map(i => (
                ...
                <div>
                    ...
                    <div className="flex items-center gap-4">
                        <input
                            ...
                            onChange={(e) => updateFirmographics({ companySizeMin: parseInt(e.target.value) || 0 })}
                        ...
                        <input
                            ...
                            onChange={(e) => updateFirmographics({ companySizeMax: parseInt(e.target.value) || 0 })}
                            className="w-32 border border-[#E5E6E3] rounded-xl px-4 py-2 text-sm focus:outline-none focus:border-[#2D3538]"
                            placeholder="Max"
                        />
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center">
                            ...
                            <input
                                ...
                                onChange={(e) => updateFirmographics({ revenueMin: parseInt(e.target.value) || 0 })}
                                className="w-32 border border-[#E5E6E3] rounded-xl px-4 py-2 text-sm focus:outline-none focus:border-[#2D3538]"
                                placeholder="Min"
                            />
                        </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <input
                                ...
                                onChange={(e) => updateFirmographics({ revenueMax: parseInt(e.target.value) || 0 })}
                                className="w-32 border border-[#E5E6E3] rounded-xl px-4 py-2 text-sm focus:outline-none focus:border-[#2D3538]"
                                placeholder="Max"
                            />
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {OPERATING_MODEL_OPTIONS.map(opt => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl text-sm transition-all ${operatingModel === opt.value
                        ...
                        <div className="flex flex-wrap gap-2">
                            {SALES_MOTION_OPTIONS.map(opt => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl text-sm transition-all ${salesMotion === opt.value
                                            ? 'bg-[#2D3538] text-white'
                                            : 'bg-[#F3F4EE] text-[#5B5F61] hover:bg-[#E5E6E3]'
                                        }`}
                                >
