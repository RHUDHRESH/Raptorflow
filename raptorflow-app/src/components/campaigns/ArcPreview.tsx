    ...
    <div className="h-full flex flex-col space-y-6 animate-in fade-in slide-in-from-right-4 duration-700">
      <div className="space-y-1">
        <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-stone-400">
          90-Day Strategic Arc
        </h3>
        <p className="text-sm font-serif text-stone-600">
          Iterative momentum for {objective}
        </p>
      </div>
            ...
            <div key={move.id} className="relative pl-8 group">
              ...
              <div
                className={cn(
                  ...
                  i === 0
                    ? 'border-stone-800 ring-4 ring-stone-50'
                    : 'border-stone-200'
                )}
              >
                {i === 0 ? (
                  <Target className="w-3 h-3 text-stone-800" />
                ) : (
      ...
      {moves.length > 0 && (
        <div className="pt-4 border-t border-stone-100 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-[10px] font-mono text-stone-800 font-bold">
              85%
            </span>
          </div>
        </div>
