...
export function CampaignWrapupModal({ campaign, open, onOpenChange, onComplete }: CampaignWrapupProps) {
    ...
    const handleSkip = () => {
        if (!confirm('Are you sure you want to skip the review? Learnings will be lost.')) return;
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl bg-zinc-50 dark:bg-zinc-950 p-0 overflow-hidden">
                <div className="p-6 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
                    <h2 className="font-display text-xl font-semibold mb-1">Campaign Wrap-up</h2>
                    <p className="text-sm text-zinc-500">Capture learnings before archiving {campaign.name}.</p>
                </div>

                <div className="p-6 space-y-6">
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-zinc-900 dark:text-zinc-100">What worked well?</label>
                        <textarea
                            value={whatWorked}
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-zinc-900 dark:text-zinc-100">What didn't work?</label>
                        <textarea
                            value={whatDidnt}
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-zinc-900 dark:text-zinc-100">Biggest Insight</label>
                        <input
                            type="text"
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-zinc-900 dark:text-zinc-100">Recommended Next Step</label>
                        <input
                            type="text"
                            value={nextRec}
