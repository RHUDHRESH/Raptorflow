...
export function MatrixEmptyState({
  title,
  message,
}: {
  title: string;
...
export function TelemetryEmptyState() {
  return (
    <div className="h-full flex flex-col items-center justify-center p-12 text-center space-y-4">
      ...
      <div>
        <h3 className="font-display text-lg text-primary/60">
          Silence in the Spine
        </h3>
        <p className="text-sm text-muted-foreground max-w-[250px] mx-auto mt-2">
          No agentic activity detected in the last 24 hours. The ecosystem is
          currently dormant.
        </p>
      </div>
    </div>
