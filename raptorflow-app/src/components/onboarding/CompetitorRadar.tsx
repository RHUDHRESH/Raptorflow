...
const INDUSTRY_ARCHETYPES: Record<string, CompetitorArchetype[]> = {
  saas: [
    ...
    {
      name: 'The Disruptor',
      description: 'Fast-moving startups with fresh angles',
      threat: 'medium',
    },
    {
      name: 'The Feature Creep',
      description: 'Platforms expanding into your space',
      threat: 'medium',
    },
  ],
  marketing: [
    {
      name: 'The Agency',
      description: 'Full-service firms with relationships',
      threat: 'high',
    },
    {
      name: 'The Tool Stack',
      description: 'Point solutions users already have',
      threat: 'medium',
    },
    {
      name: 'The DIY',
      description: 'Customers doing it themselves',
      threat: 'low',
    },
  ],
  default: [
    {
      ...
      description: 'Dominant player in your category',
      threat: 'high',
    },
    {
      name: 'The Niche Player',
      description: 'Specialists who own a segment',
      threat: 'medium',
    },
    {
      name: 'The Substitute',
      description: 'Different solutions to the same problem',
      threat: 'low',
    },
  ],
};
...
export function CompetitorRadar({
  ...
  const [phase, setPhase] = useState<'scanning' | 'revealing' | 'complete'>(
    'scanning'
  );
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            ...
            <span className="text-sm font-medium text-foreground">
              {phase === 'scanning'
                ? 'Scanning...'
                : `${archetypes.length} archetypes detected`}
            </span>
          </div>
        </div>
