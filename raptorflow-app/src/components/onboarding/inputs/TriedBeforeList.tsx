...
const emptyEntry: TriedBefore = {
  toolOrService: '',
  whatYouHoped: '',
  whatFailed: '',
};

export function TriedBeforeList({
  value = [],
  onChange,
}: TriedBeforeListProps) {
          ...
          <div className="space-y-4 mt-2">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateEntry(index, 'toolOrService', e.target.value)
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateEntry(index, 'whatYouHoped', e.target.value)
                }
                className="h-11 text-base bg-background border-2 focus-visible:ring-0 focus-visible:border-primary"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateEntry(index, 'whatFailed', e.target.value)
                }
                className="h-11 text-base bg-background border-2 focus-visible:ring-0 focus-visible:border-primary"
              />
            </div>
