...
export function PitchScript({ data, className }: PitchScriptProps) {
  ...
  const script = useMemo(() => {
    ...
    const lines = [
      ...
      // Belief (10 seconds)
      beliefPillar ? `We believe ${beliefPillar}.` : '',

      // Promise (10 seconds)
      promisePillar ? `That's why we promise ${promisePillar}.` : '',

      // Proof (5 seconds)
      proofPillar ? `And we prove it by ${proofPillar}.` : '',
