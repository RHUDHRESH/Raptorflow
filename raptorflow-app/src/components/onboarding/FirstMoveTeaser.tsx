  ...
  const recommendation = useMemo((): MoveRecommendation | null => {
    ...
    if (
      ...
      if (
        ...
        buyerRole?.toLowerCase().includes('founder')
      ) {
        return {
          title: 'Executive Thought Leadership Series',
          description:
            'Build authority with a LinkedIn content strategy targeting founders and C-suite.',
          channel: 'LinkedIn',
        };
      }
      if (
        buyerRole?.toLowerCase().includes('cfo') ||
        buyerRole?.toLowerCase().includes('finance')
      ) {
        return {
          title: 'ROI-Focused Case Study',
          description:
            'Create a data-driven case study showing financial impact for CFOs.',
      ...
      return {
        ...
        description:
          'Targeted outreach sequence to decision-makers with value-first messaging.',
        channel: 'Email',
      };
    }
    ...
    if (
      ...
      if (stage === 'early' || stage === 'idea') {
        return {
          ...
          description:
            'Build initial audience via Twitter/X threads and community engagement.',
      ...
      return {
        ...
        description:
          'Create short-form video content optimized for organic reach.',
    ...
    return {
      ...
      description:
        'Establish your unique position with a 7-day content series.',
