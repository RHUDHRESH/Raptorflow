...
const changelogEntries = [
    {
        ...
        description: 'New experimental sandbox for growth marketing with A/B testing capabilities and gamification elements.',
        changes: [
    ...
    },
    {
        ...
        description: 'Improved move library with templates, custom move creation, and better user experience.',
        changes: [
    ...
    },
    {
        ...
        description: 'Fixed loading issues and improved overall performance across the platform.',
        changes: [
    ...
    },
    {
        ...
        description: 'Advanced market intelligence and competitive analysis system.',
        changes: [
    ...
    },
    {
        ...
        description: 'Complete redesign of the RaptorFlow platform with new architecture and improved user experience.',
        changes: [
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed mb-8">
                            Follow our journey as we build the marketing operating system for founders.
                ...
                <div className="mx-auto max-w-4xl px-6 lg:px-8">
                    <div className="space-y-12">
                        {filteredEntries.map((entry) => (
                            <div key={entry.version} className="border-b border-border pb-12 last:border-b-0">
                                <div className="flex items-start justify-between mb-4">
                                    <div>
                                        <div className="flex items-center gap-3 mb-2">
                                            <h2 className="font-display text-2xl font-semibold">{entry.version}</h2>
                                            <span
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="text-lg text-muted-foreground mb-8">
                            We're building fast. Check our roadmap for upcoming features and improvements.
                        </p>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                        <div>
                            ...
                            <div className="text-sm text-muted-foreground">Releases This Year</div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="text-sm text-muted-foreground">Update Cadence</div>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="text-lg text-background/70 mb-8">
                            Subscribe to our changelog RSS feed or newsletter to never miss an update.
                        </p>
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Button variant="secondary" size="lg" className="h-14 px-8 text-base rounded-xl">
                                Subscribe to RSS Feed
                            </Button>
                            <Button variant="outline" size="lg" className="h-14 px-8 text-base rounded-xl border-background/20 text-background hover:bg-background/10">
                                Join Newsletter
                            </Button>
                        </div>
                    </div>
