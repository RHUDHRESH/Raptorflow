...
const openPositions = [
  {
    ...
    posted: '2024-12-15',
    description:
      'Build the frontend experience for our marketing operating system. You will work on React, Next.js, and modern web technologies to create beautiful, performant interfaces that founders love.',
    requirements: [
  ...
  },
  {
    ...
    posted: '2024-12-10',
    description:
      'Drive product marketing strategy and execution for RaptorFlow. You will own positioning, messaging, and go-to-market for new features and products that help founders succeed.',
    requirements: [
  ...
  },
  {
    ...
    posted: '2024-12-08',
    description:
      'Help founders succeed with RaptorFlow. You will onboard customers, provide strategic guidance, and ensure they get maximum value from our marketing operating system.',
    requirements: [
  ...
  },
  {
    ...
    posted: '2024-12-05',
    description:
      'Build scalable backend systems for our marketing operating system. You will work on APIs, data processing, and infrastructure that powers our platform.',
    requirements: [
  ...
  },
  {
    ...
    posted: '2024-12-01',
    description:
      'Push the boundaries of AI in marketing. You will work on cutting-edge machine learning models for content generation, campaign optimization, and market intelligence.',
    requirements: [
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed mb-8">
              Join a team that is obsessed with helping founders build marketing
      ...
      <section className="border-y border-border bg-muted/30 py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <h2 className="font-display text-3xl lg:text-4xl font-medium mb-12">
              Why Join RaptorFlow
            </h2>
            <div className="grid lg:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  We are not just building another SaaS tool. We are solving a
                  real problem that affects millions of founders worldwide. Your
                  work will directly help businesses grow and succeed.
                </p>
                <h3 className="text-xl font-semibold mb-4">Learn and Grow</h3>
                <p className="text-muted-foreground">
                  Work alongside experienced founders, marketers, and engineers.
                  You will be challenged, learn constantly, and have
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  We are distributed across the globe but connected by our
                  mission. Work from anywhere, with flexible hours that fit your
                  life. We care about results, not face time.
                </p>
                <h3 className="text-xl font-semibold mb-4">Build in Public</h3>
                <p className="text-muted-foreground">
                  We believe in transparency and building in public. You will
                  have direct access to users, see the impact of your work, and
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  We ship quickly and iterate based on feedback. Speed is our
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  We start with the customer and work backwards. Their success
                  is our success.
                </p>
              </div>
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  We stay curious and embrace challenges. Every day is an
                  opportunity to grow.
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Join us in helping millions of founders build marketing that
              actually compounds.
            </p>
