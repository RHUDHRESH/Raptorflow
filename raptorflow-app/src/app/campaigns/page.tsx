...
import { ArrowRight, Search, ChevronDown, Target, Rocket } from 'lucide-react';
...
export default function CampaignsPage() {
  ...
  const filteredCampaigns = campaigns.filter((c) => {
    ...
    if (objectiveFilter !== 'all' && c.objective !== objectiveFilter)
      return false;
  ...
  const needsAttention = filteredCampaigns.filter(
    (c) =>
      c.status === 'active' &&
      (c.ragStatus === 'amber' || c.ragStatus === 'red')
  );
  const activeCampaigns = filteredCampaigns.filter(
    (c) => c.status === 'active' && c.ragStatus === 'green'
  );
            ...
            {isEmpty ? (
              ...
              <div className={styles.emptyState}>
                ...
                <p className={styles.emptyText}>
                  Campaigns are 90-day focused initiatives. Each one contains
                  Moves - tactical sprints that drive real results.
                </p>
                <div className={styles.emptyActions}>
                  <div className={styles.emptyTile}>
                    ...
                    <div className={styles.emptyTileTitle}>
                      No campaigns yet
                    </div>
                    <div className={styles.emptyTileDesc}>
                      Create campaigns from Mission Control.
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className={styles.section}>
                    <div className={styles.sectionHeader}>
                      <div className={styles.sectionIndicator}>
                        <div
                          className={`${styles.sectionDot} ${styles.attention}`}
                        />
                    ...
                    <div
                      className={`${styles.campaignsGrid} ${needsAttention.length === 1 ? styles.single : ''}`}
                    >
                ...
                {activeCampaigns.length > 0 && (
                  <div className={styles.section}>
                    <div className={styles.sectionHeader}>
                      <div className={styles.sectionIndicator}>
                        <div
                          className={`${styles.sectionDot} ${styles.active}`}
                        />
                ...
                {scheduledCampaigns.length > 0 && (
                  <div className={styles.section}>
                    <div className={styles.sectionHeader}>
                      <div className={styles.sectionIndicator}>
                        <div
                          className={`${styles.sectionDot} ${styles.scheduled}`}
                        />
                ...
                {completedCampaigns.length > 0 && (
                  <div className={styles.section}>
                    <div className={styles.sectionHeader}>
                      <div className={styles.sectionIndicator}>
                        <div
                          className={`${styles.sectionDot} ${styles.completed}`}
                        />
                        <span className={styles.sectionTitle}>
                          Completed / Archived
                        </span>
