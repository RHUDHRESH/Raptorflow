    ...
    <div className={styles.section}>
        ...
        <div className={styles.teamList}>
          ...
          {icps.map((icp: any) => (
            <div key={icp.id} className={styles.teamRow}>
              <div
                className={`${styles.avatarSmall} bg-slate-100 text-slate-600`}
              >
                {icp.name.substring(0, 2).toUpperCase()}
              </div>
              <div className={styles.teamInfo}>
                <span className={styles.teamName}>{icp.name}</span>
                <span className={styles.teamEmail}>
                  Confidence: {(icp.confidenceScore * 100).toFixed(0)}%
                </span>
              </div>
              {activeIcpId === icp.id ? (
                <span
                  className={`${styles.roleBadge} bg-green-100 text-green-700`}
                >
                  Active
                </span>
              ) : (
      ...
      <div className={styles.card}>
        ...
        <p className="text-sm text-slate-500 mb-4">
          Your Active ICP determines how Muse writes content and how campaigns
          are structured. Always keep your primary target up to date.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className={styles.section}>
      <div className={styles.sectionHeader}>
        ...
        <p className={styles.sectionDescription}>
          Manage your workspace settings and foundation.
        </p>
      </div>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.optionRow}>
          <div>
            ...
            <span className={styles.optionMeta}>
              Reminders for upcoming moves
            </span>
          </div>
          <Switch
            checked={notifications.moveReminders}
            onCheckedChange={() => toggle('moveReminders')}
          />
        </div>
        <div className={styles.optionRow}>
          <div>
        ...
        <div className={styles.optionRow}>
          <div>
            ...
            <span className={styles.optionMeta}>
              Alerts for campaigns needing attention
            </span>
          </div>
          <Switch
            checked={notifications.campaignAlerts}
            onCheckedChange={() => toggle('campaignAlerts')}
          />
        </div>
        <div className={styles.optionRow}>
          <div>
          ...
          <Switch
            ...
            onCheckedChange={() => toggle('productUpdates')}
          />
        </div>
      </div>
    </div>
