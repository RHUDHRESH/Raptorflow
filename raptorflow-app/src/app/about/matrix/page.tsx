...
import { ArrowRight, Activity, Shield, AlertTriangle, Zap, Eye, Power } from 'lucide-react';
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24 lg:py-32">
                    <div className="max-w-4xl">
                        ...
                        <h1 className="font-display text-6xl md:text-7xl lg:text-8xl font-normal tracking-tight text-foreground leading-[0.9] mb-8">
                            See everything.<br />
                            <span className="italic text-muted-foreground">Control</span> everything.
                        </h1>

                        <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-2xl font-light mb-16">
                            Matrix is your industrial-grade command center.
                            Monitor agents, track costs, detect drift—and kill
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="flex flex-wrap justify-between items-center gap-8">
                        ...
                        <div className="flex items-center gap-6 font-mono text-sm text-background/60">
                            <span>AGENTS: <span className="text-background">7 ACTIVE</span></span>
                            <span>LATENCY: <span className="text-background">42ms</span></span>
                            <span>BURN: <span className="text-background">$2.14/day</span></span>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-12 gap-16 items-start">
                        <div className="lg:col-span-4">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl font-normal tracking-tight">
                                Flying blind in<br />an AI world.
                            </h2>
                        </div>
                        <div className="lg:col-span-7 lg:col-start-6">
                            <div className="prose prose-lg text-muted-foreground space-y-6">
                                <p className="text-xl leading-relaxed">
                                    You&apos;ve deployed AI agents. They&apos;re generating content,
                                    analyzing data, making decisions. But do you actually know
                                    what they&apos;re doing?
                                </p>
            ...
            <section className="border-y border-foreground/10 py-24 lg:py-32 bg-muted/20">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="max-w-xl mb-20">
                        ...
                        <h2 className="font-display text-4xl md:text-5xl font-normal tracking-tight">
                            Industrial-grade<br />control surfaces.
                        </h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
                        ...
                        <div className="relative">
                            ...
                            <p className="text-muted-foreground leading-relaxed">
                                Real-time visibility into every AI agent in your marketing stack.
                                See what they&apos;re doing, what they&apos;re deciding, and how
                                they&apos;re performing. One unified view.
                            </p>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <p className="text-muted-foreground leading-relaxed">
                                Track token burn, inference costs, and ROI in real time.
                                Know exactly what your AI is costing you—and whether
                                it&apos;s worth it. Budget alerts before you overspend.
                            </p>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <p className="text-muted-foreground leading-relaxed">
                                ...
                                One-click kill switch for any agent, any campaign, any
                                process. Control that matches the speed of AI.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <blockquote className="max-w-4xl">
                        <p className="font-display text-3xl md:text-4xl lg:text-5xl font-normal leading-tight">
                            &ldquo;With AI, what you can&apos;t see <em className="not-italic text-muted-foreground">can</em> hurt you.
                            Matrix makes the invisible visible.&rdquo;
                        </p>
                    </blockquote>
                </div>
            </section>
            ...
            <section className="border-y border-foreground/10 bg-foreground text-background py-24">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid md:grid-cols-4 gap-12 text-center">
                        <div>
                            <div className="font-mono text-5xl lg:text-6xl font-light mb-2">P95</div>
                            <div className="text-sm text-background/60 uppercase tracking-wider">Latency Tracking</div>
                        </div>
                        <div>
                            <div className="font-mono text-5xl lg:text-6xl font-light mb-2">24/7</div>
                            <div className="text-sm text-background/60 uppercase tracking-wider">Agent Monitoring</div>
                        </div>
                        <div>
                            <div className="font-mono text-5xl lg:text-6xl font-light mb-2">$0.00</div>
                            <div className="text-sm text-background/60 uppercase tracking-wider">Surprise Costs</div>
                        </div>
                        <div>
                            <div className="font-mono text-5xl lg:text-6xl font-light mb-2">&lt;1s</div>
                            <div className="text-sm text-background/60 uppercase tracking-wider">Kill Response</div>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h2 className="font-display text-4xl md:text-5xl font-normal tracking-tight mb-8">
                                Every decision,<br />fully auditable.
                            </h2>
                            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                                Deep inspection of raw agent inputs, tool calls, and LLM responses.
                                Know not just what your AI decided, but why. Complete audit trail
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-sm font-medium">Full inference log exploration</span>
                            </div>
                        </div>

                        {/* Visual representation */}
                        <div className="bg-muted/30 rounded-2xl p-8 font-mono text-xs space-y-3 border border-foreground/5">
                            <div className="text-muted-foreground">[14:32:01] Agent: muse_briefer</div>
                            <div className="text-muted-foreground">[14:32:01] Input: &quot;Generate LinkedIn post for Q1 launch&quot;</div>
                            <div className="text-muted-foreground">[14:32:02] Context: Foundation.positioning + Cohort.early_founders</div>
                            <div className="text-muted-foreground">[14:32:03] Tool: content_generator.create_post</div>
                            <div className="text-foreground">[14:32:04] Output: &quot;Marketing. Finally under control...&quot;</div>
                            <div className="text-green-600">[14:32:04] Status: SUCCESS | Tokens: 847 | Cost: $0.02</div>
                        </div>
                    </div>
                </div>
            </section>
