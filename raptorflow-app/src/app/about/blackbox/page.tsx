...
import { ArrowRight, FlaskConical, TrendingUp, Brain, Target, RotateCcw, CheckCircle2 } from 'lucide-react';
        ...
        <MarketingLayout>
            ...
            <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 -z-10">
                    ...
                    <svg className="absolute inset-0 w-full h-full opacity-[0.04]" viewBox="0 0 1000 1000" preserveAspectRatio="none">
                        <path d="M100,500 C300,300 400,700 600,500 S800,300 900,500" stroke="currentColor" strokeWidth="2" fill="none" />
                        <path d="M100,600 C300,400 400,800 600,600 S800,400 900,600" stroke="currentColor" strokeWidth="1" fill="none" />
                        {/* Data points */}
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24 lg:py-32">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-2xl font-light mb-16">
                            Blackbox is your experimentation engine. Track outcomes,
                            extract learnings, and harden your strategy through evidence—not opinions.
                        </p>

                        <Button asChild size="lg" className="h-14 px-10 text-base rounded-full group">
                            <Link href="/blackbox">
                                Enter Blackbox
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 py-20 lg:py-28">
                    <blockquote className="max-w-4xl">
                        <p className="font-display text-3xl md:text-4xl lg:text-5xl font-normal leading-tight">
                            ...
                            <em className="not-italic border-b-2 border-background/50"> expensive guessing</em>.&rdquo;
                        </p>
                    </blockquote>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-12 gap-16 items-start">
                        <div className="lg:col-span-4">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl font-normal tracking-tight">
                                Hope is not<br />a strategy.
                            </h2>
                        </div>
                        <div className="lg:col-span-7 lg:col-start-6">
                            <div className="prose prose-lg text-muted-foreground space-y-6">
                                <p className="text-xl leading-relaxed">
                                    You launched that campaign. You shipped those posts.
                                    You changed the landing page headline. But did any of it
                                    <em>actually</em> work?
                                </p>
                                <p className="text-lg leading-relaxed">
                                    Marketing by gut feel. A/B testing that never happens because
                                    &ldquo;we don&apos;t have time.&rdquo; Decisions based on the
                                    loudest voice in the room instead of the clearest data.
                                    Every quarter starts from scratch because nothing compounds.
                                </p>
            ...
            <section className="border-y border-foreground/10 py-24 lg:py-32 bg-muted/20">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="max-w-xl mb-20">
                        ...
                        <h2 className="font-display text-4xl md:text-5xl font-normal tracking-tight">
                            Every experiment<br />feeds the next.
                        </h2>
                    </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
                            ...
                            <div className="p-8 rounded-2xl border border-foreground/10 bg-background">
                                <div className="flex items-center gap-4 mb-6">
                                    <span className="font-mono text-4xl font-light text-foreground/20">01</span>
                                    <Target className="h-6 w-6 text-foreground" />
                                </div>
                                <h3 className="font-display text-2xl mb-4">Hypothesize</h3>
                                <p className="text-muted-foreground leading-relaxed">
                                    Define what you want to test. &ldquo;CTA variant A will outperform B&rdquo; —
                                    &ldquo;Video posts drive more engagement than static&rdquo; —
                                    &ldquo;Pain-focused messaging converts better than aspiration.&rdquo;
                                </p>
                            </div>
                            ...
                            <div className="p-8 rounded-2xl border border-foreground/10 bg-background">
                                <div className="flex items-center gap-4 mb-6">
                                    <span className="font-mono text-4xl font-light text-foreground/20">02</span>
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    ...
                                    everything automatically—or you check in manually.
                                    Either way, the data gets captured.
                                </p>
                            </div>
                            ...
                            <div className="p-8 rounded-2xl border border-foreground/10 bg-background">
                                <div className="flex items-center gap-4 mb-6">
                                    <span className="font-mono text-4xl font-light text-foreground/20">03</span>
                                    <TrendingUp className="h-6 w-6 text-foreground" />
                                </div>
                                <h3 className="font-display text-2xl mb-4">Learn</h3>
                                <p className="text-muted-foreground leading-relaxed">
                                    AI synthesizes what worked and why. Not just
                                    &ldquo;A beat B&rdquo;—but the strategic insight behind it.
                            ...
                            <div className="p-8 rounded-2xl border border-foreground/10 bg-background">
                                <div className="flex items-center gap-4 mb-6">
                                    <span className="font-mono text-4xl font-light text-foreground/20">04</span>
                                    <RotateCcw className="h-6 w-6 text-foreground" />
                                </div>
                                <h3 className="font-display text-2xl mb-4">Apply</h3>
                                <p className="text-muted-foreground leading-relaxed">
                                    Strategic pivots feed back into your Foundation,
                                    your campaigns, your Muse generations. The system
                                    gets smarter. Your marketing compounds.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h2 className="font-display text-4xl md:text-5xl font-normal tracking-tight mb-8">
                                Decisions backed<br />by proof.
                            </h2>
                            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                                Every learning in Blackbox is traceable. See the raw data,
                                the experiment that generated it, the outcome that proved it.
                                No black boxes in your Blackbox.
                            </p>
                        ...
                        <div className="space-y-4">
                            <div className="p-6 rounded-2xl border border-foreground/10 bg-muted/30">
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <span className="text-xs font-mono uppercase text-muted-foreground">Strategic Learning</span>
                                </div>
                                <p className="font-display text-lg mb-4">
                                    &ldquo;Pain-focused headlines outperform aspiration-focused by 34% for early-stage founder cohort.&rdquo;
                                </p>
                            ...
                            <div className="p-6 rounded-2xl border border-foreground/10 bg-muted/30">
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <span className="text-xs font-mono uppercase text-muted-foreground">Tactical Insight</span>
                                </div>
                                <p className="font-display text-lg mb-4">
                                    &ldquo;Video content drives 2.3x engagement on LinkedIn, but static carousels convert 1.5x better.&rdquo;
                                </p>
                                <div className="text-xs text-muted-foreground space-y-1">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <h2 className="font-display text-4xl md:text-5xl font-normal tracking-tight mb-12">
                            Marketing that<br />gets smarter every week.
                        </h2>
                        <div className="grid grid-cols-3 gap-8">
                            <div>
                                <div className="font-mono text-5xl font-light mb-2">↻</div>
                                <div className="text-sm text-background/60">Experiments run</div>
                            </div>
                            <div>
                                <div className="font-mono text-5xl font-light mb-2">→</div>
                                <div className="text-sm text-background/60">Learnings extracted</div>
                            </div>
                            <div>
                                <div className="font-mono text-5xl font-light mb-2">↑</div>
                                <div className="text-sm text-background/60">Strategy hardens</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <blockquote className="max-w-3xl mx-auto text-center">
                        <p className="font-display text-2xl md:text-3xl lg:text-4xl font-normal leading-tight text-muted-foreground">
                            Stop asking <span className="text-foreground">&ldquo;did that work?&rdquo;</span><br />
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="max-w-2xl mx-auto text-center">
                        <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight mb-8">
                            Start proving<br />what works.
                        </h2>
                        <p className="text-lg text-muted-foreground mb-12">
                            Evidence-backed marketing decisions. Strategic learnings that compound.
                        </p>
                        <Button asChild size="lg" className="h-14 px-10 text-base rounded-full group">
                            <Link href="/blackbox">
                                Enter Blackbox
