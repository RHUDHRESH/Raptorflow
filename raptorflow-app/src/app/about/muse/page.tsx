...
import { ArrowRight, Sparkles, Layers, Wand2, FileText, Palette } from 'lucide-react';
            ...
            <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 -z-10">
                    ...
                    <svg className="absolute inset-0 w-full h-full opacity-[0.03]" viewBox="0 0 1000 1000" preserveAspectRatio="none">
                        <path d="M0,500 Q250,200 500,500 T1000,500" stroke="currentColor" strokeWidth="2" fill="none" />
                        <path d="M0,600 Q250,300 500,600 T1000,600" stroke="currentColor" strokeWidth="1" fill="none" />
                    </svg>
                </div>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24 lg:py-32">
                    <div className="max-w-4xl">
                        ...
                        <h1 className="font-display text-6xl md:text-7xl lg:text-8xl font-normal tracking-tight text-foreground leading-[0.9] mb-8">
                            Where strategy<br />
                            <span className="italic text-muted-foreground">becomes</span> creation.
                        </h1>

                        {/* Subtitle — Editorial Prose */}
                        <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-2xl font-light mb-16">
                            Muse doesn&apos;t just generate content. It understands your brand,
                            speaks to your people, and creates assets that convert.
                        </p>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 py-20 lg:py-28">
                    <blockquote className="max-w-4xl">
                        <p className="font-display text-3xl md:text-4xl lg:text-5xl font-normal leading-tight">
                            &ldquo;AI that actually sounds like <em className="not-italic border-b-2 border-background/50">you</em>—
                            because it&apos;s trained on your positioning, your voice, your strategy.&rdquo;
                        </p>
                    </blockquote>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-12 gap-16 items-start">
                        <div className="lg:col-span-4">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl font-normal tracking-tight">
                                Content without<br />context is noise.
                            </h2>
                        </div>
                        <div className="lg:col-span-7 lg:col-start-6">
                            <div className="prose prose-lg text-muted-foreground space-y-6">
                                <p className="text-xl leading-relaxed">
                                    You&apos;ve tried ChatGPT. Copied prompts from Twitter threads.
                                    Paid for AI writing tools that produce content indistinguishable
                                    from every other company in your space.
                                </p>
                                <p className="text-lg leading-relaxed">
                                    The output sounds generic because the input is generic.
                                    AI doesn&apos;t know your positioning. It doesn&apos;t understand
            ...
            <section className="border-y border-foreground/10 py-24 lg:py-32 bg-muted/20">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="max-w-xl mb-20">
                        ...
                        <h2 className="font-display text-4xl md:text-5xl font-normal tracking-tight">
                            From thought to asset,<br />in moments.
                        </h2>
                    </div>
                    ...
                    <div className="space-y-20">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                            <div className="md:w-32 flex-shrink-0">
                                <span className="font-display text-7xl text-foreground/10">01</span>
                            </div>
                            <div className="flex-1 max-w-xl">
                                ...
                                <h3 className="font-display text-2xl mb-4">Describe what you need</h3>
                        ...
                        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start md:ml-24">
                            <div className="md:w-32 flex-shrink-0">
                                <span className="font-display text-7xl text-foreground/10">02</span>
                            </div>
                            <div className="flex-1 max-w-xl">
                                <div className="h-12 w-12 rounded-full bg-foreground/5 flex items-center justify-center mb-6">
                                    <Layers className="h-5 w-5 text-foreground" />
                                </div>
                                <h3 className="font-display text-2xl mb-4">Context injection</h3>
                                <p className="text-muted-foreground leading-relaxed">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start md:ml-48">
                            <div className="md:w-32 flex-shrink-0">
                                <span className="font-display text-7xl text-foreground/10">03</span>
                            </div>
                            <div className="flex-1 max-w-xl">
                                <div className="h-12 w-12 rounded-full bg-foreground/5 flex items-center justify-center mb-6">
                                    <Sparkles className="h-5 w-5 text-foreground" />
                                </div>
                                <h3 className="font-display text-2xl mb-4">On-brand generation</h3>
                                <p className="text-muted-foreground leading-relaxed">
                                    Multiple variants, each connected to your strategy.
                                    A/B testing built in. Voice consistency guaranteed.
                                    Content that sounds like you, not like everyone else.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start md:ml-24">
                            <div className="md:w-32 flex-shrink-0">
                                <span className="font-display text-7xl text-foreground/10">04</span>
                            </div>
                            <div className="flex-1 max-w-xl">
                                <div className="h-12 w-12 rounded-full bg-foreground/5 flex items-center justify-center mb-6">
                                    <FileText className="h-5 w-5 text-foreground" />
                                </div>
                                <h3 className="font-display text-2xl mb-4">Polish and deploy</h3>
                                <p className="text-muted-foreground leading-relaxed">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 py-20 lg:py-28">
                    <blockquote className="max-w-3xl mx-auto text-center">
                        <p className="font-display text-2xl md:text-3xl lg:text-4xl font-normal leading-tight text-muted-foreground">
                            Stop <span className="text-foreground">editing AI output</span> for hours.<br />
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="max-w-2xl mx-auto text-center">
                        <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight mb-8">
                            Your creative engine<br />awaits.
                        </h2>
                        <p className="text-lg text-muted-foreground mb-12">
                            Connected to your strategy. Trained on your voice. Ready to create.
                        </p>
                        <Button asChild size="lg" className="h-14 px-10 text-base rounded-full group">
                            <Link href="/muse">
                                Try Muse Free
