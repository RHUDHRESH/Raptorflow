        ...
        <AppLayout>
            <Stagger className="flex flex-col gap-20 md:gap-24 pb-32">
                ...
                <section className="flex flex-col gap-4 max-w-3xl pt-8">
                    <FadeIn>
                        <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight text-foreground leading-[1.1]">
                            {new Date().getHours() < 12 ? 'Good morning,' : new Date().getHours() < 18 ? 'Good afternoon,' : 'Good evening,'} Founder.
                        </h1>
                    </FadeIn>
                    <FadeIn delay={1}>
