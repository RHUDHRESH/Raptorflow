        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                By accessing and using RaptorFlow ("the Service"), you accept
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                RaptorFlow is a marketing platform that provides tools and
                services for creating, managing, and optimizing marketing
                campaigns. The service includes features such as campaign
                management, analytics, content creation, and performance
                tracking.
              </p>
            </div>
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                ...
                through the service. By using our service, you grant us a
                license to use, modify, and display your content for the purpose
              ...
              <p>
                ...
                us to use all patent, trademark, trade secret, copyright, or
                other proprietary rights in and to any and all content to enable
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                RaptorFlow offers various subscription plans with different
                features and pricing. You agree to pay all fees and charges
                incurred in connection with your account at the rates in effect
                when such charges are incurred.
              </p>
              <p>
                All fees are charged in Indian Rupees (INR) and are
                non-refundable except as expressly provided in these terms. We
                reserve the right to modify our fees at any time.
              </p>
            </div>
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                ...
                purpose. You agree not to use the service to:
              </p>
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                ...
                RaptorFlow and its licensors. The service is protected by
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                We strive to maintain the service's availability, but we do not
                guarantee that the service will be available at all times. We
                may experience hardware, software, or other problems that could
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                In no event shall RaptorFlow, our directors, employees,
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <div className="space-y-2">
                <p>
                  ...
                  <br />
                  Email: legal@raptorflow.com
                  <br />
                  Website: www.raptorflow.com
                </p>
                <p className="text-sm">
                  These Terms of Service are effective as of December 26, 2024
                  and govern your use of the RaptorFlow service.
                </p>
              </div>
            </div>
          </div>
