        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                This Cookie Policy explains how RaptorFlow uses cookies and
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Functional Cookies:</strong> These enable the website
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  that are erased when you close your browser.
                </li>
                <li>
                ...
                <li>
                  <strong>First-Party Cookies:</strong> These are set by our
                  website directly.
                </li>
                <li>
                  <strong>Third-Party Cookies:</strong> These are set by
                  external services we use on our website.
                </li>
              </ul>
            </div>
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                We may use third-party services that set their own cookies on
                your device when you use our website. These third-party services
                include:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Analytics Services:</strong> Google Analytics and
                  similar tools to understand website usage patterns.
                </li>
                <li>
                  <strong>Payment Processors:</strong> Secure payment gateways
                  for processing subscriptions and transactions.
                </li>
                <li>
                  <strong>Marketing Platforms:</strong> Tools for tracking
                  campaign performance and user engagement.
                </li>
                <li>
                  <strong>Social Media:</strong> Integration with social media
                  platforms for sharing and authentication.
                </li>
              </ul>
            </div>
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  control cookies through their settings. You can accept or
                  reject cookies, or delete specific cookies.
                </li>
                <li>
                  <strong>Cookie Consent Banner:</strong> When you first visit
                  our website, you'll see a cookie consent banner where you can
                  choose which types of cookies to accept.
                </li>
                <li>
                  <strong>Opt-Out Tools:</strong> Some third-party services
                  provide opt-out tools for their advertising cookies.
                </li>
              </ul>
              <p>
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Persistent Cookies:</strong> Typically expire after 30
                  days to 2 years
                </li>
                <li>
                  <strong>Authentication Cookies:</strong> Expire after 24 hours
                  of inactivity
                </li>
                <li>
                  <strong>Analytics Cookies:</strong> Expire after 2 years
                </li>
              </ul>
            </div>
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Know what personal data is being collected through cookies
                </li>
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <p>
                ...
                changes in our use of cookies, legal requirements, or business
            ...
            <div className="text-gray-700 leading-relaxed space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm">
                  This Cookie Policy is effective as of December 26, 2024 and
