...
export const ICP_TEMPLATES: Record<string, IcpTemplate> = {
    techFounder: {
        ...
        reasoning: 'Based on your B2B focus and founder-level buyer role, this ICP targets ambitious tech founders who need efficient solutions.',
        ...
        excludedBehaviors: ['Needs long procurement cycles', 'Risk-averse committees']
    },

    corporateDecider: {
        id: 'corporate-decider',
        defaultName: 'The Corporate Decision Maker',
        reasoning: 'Based on your enterprise-level targeting, this ICP captures senior executives who prioritize proven solutions.',
        ...
        baseWordsToUse: ['enterprise-grade', 'proven', 'trusted', 'secure', 'compliant'],
    ...
    smbOperator: {
        ...
        reasoning: 'Targets hands-on business operators who need practical, affordable solutions.',
    ...
    marketingLead: {
        ...
        reasoning: 'Targets marketing professionals who need to prove their impact and move fast.',
    ...
    earlyAdopter: {
        ...
        reasoning: 'Based on your early stage and B2C focus, this ICP targets trend-conscious consumers who love being first.',
        ...
        baseWordsToUse: ['first', 'new', 'exclusive', 'innovative', 'before everyone'],
    ...
    massMarket: {
        ...
        reasoning: 'Targets mainstream consumers who want proven, trusted solutions.',
