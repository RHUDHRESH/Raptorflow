...
export const mockDerivedData: DerivedData = {
    ...
    icps: [
        {
            ...
            priority: 'primary',
            confidence: 94,
            description: 'Early-stage SaaS founders who are tired of guessing and want a system.',
            firmographics: {
            ...
            social: {
                platforms: [
                    { name: 'LinkedIn', timing: 'Daily, morning scroll', vibe: 'Professional but personal' },
                    { name: 'Twitter / X', timing: 'Evening', vibe: 'Vent, learn, connect' }
                ],
            ...
            behavioral: {
                biases: [{ name: 'Authority Bias', implication: 'Trusts other founders more than sales reps' }],
        ...
        },
        {
            ...
            priority: 'secondary',
            confidence: 88,
            description: 'Solo marketers or small team leads at Series A companies needing structure.',
            firmographics: {
            ...
            social: {
                platforms: [{ name: 'LinkedIn', timing: 'Work hours', vibe: 'Networking' }],
            ...
            behavioral: {
                biases: [{ name: 'Sunk Cost', implication: 'Reluctant to switch from HubSpot completely' }],
    ...
    positioning: {
        matrix: {
            xAxis: { label: 'Complexity', lowEnd: 'Simple / Plug-n-Play', highEnd: 'Enterprise / Custom' },
            yAxis: { label: 'Focus', lowEnd: 'Generalist Tool', highEnd: 'Specialized OS' },
            positions: [
        ...
        ladder: [
            { rung: 1, name: 'Feature', description: 'AI Marketing Tool', score: 20, isYou: false },
            { rung: 2, name: 'Benefit', description: 'Faster Content Creation', score: 45, isYou: false },
            { rung: 3, name: 'Outcome', description: 'Automated Lead Gen', score: 70, isYou: false },
            { rung: 4, name: 'Identity', description: 'Founder Marketing OS', score: 95, isYou: true }
        ],
        statement: {
            ...
            unlikeCompetitor: 'unlike general project management tools or disconnected AI writers',
    ...
    competitive: {
        statusQuo: {
            ...
            description: 'The default state of most startups: random acts of marketing.',
            manualPatches: ['Google Sheets content cal', 'Notion docs for strategy', 'Slack for coordination'],
        ...
        indirect: [
            {
                ...
                weakness: 'Slow, expensive, and they don\'t understand your product like you do.',
        ...
        direct: [
            {
                ...
                yourEdge: 'Purpose-built for lean execution, not just database management.',
    ...
    // 4. SOUNDBITES REVEAL
    soundbites: {
        oneLiner: 'Stop guessing. Start executing. The operating system for founder-led growth.',
        soundbites: [
            {
                type: 'problem',
    ...
    market: {
        ...
        assumptions: [
            { factor: 'Total SaaS Founders', value: '150,000 active', confidence: 'high' },
            { factor: 'Willingness to Pay', value: 'Expected to rise', confidence: 'med' },
