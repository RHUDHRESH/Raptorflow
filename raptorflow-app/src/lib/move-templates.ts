...
export const MOVE_TEMPLATES: MoveTemplate[] = [
  ...
  // ==============================
  {
    ...
    description:
      '1 post/day → pain → promise → CTA. Build authority by articulating problems.',
    goal: 'leads',
    duration: 7,
    effortPerDay: '20m',
    outputs: ['7 posts', '1 CTA script'],
    hypothesis:
      'If we post daily about ICP pain points, we will generate 20+ qualified leads',
    ...
    defaultChecklist: [
      {
        label: 'Draft Post #1: Problem framing',
        completed: false,
        group: 'create',
      },
      { label: 'Post it', completed: false, group: 'publish' },
      {
        label: 'Draft Post #2: Stakes & cost of inaction',
        completed: false,
        group: 'create',
      },
      { label: 'Post it', completed: false, group: 'publish' },
      {
        label: 'Draft Post #3: Objection-killer',
        completed: false,
        group: 'create',
      },
      { label: 'Post it', completed: false, group: 'publish' },
      {
        label: 'Draft Post #4: Behind-the-scenes story',
        completed: false,
        group: 'create',
      },
      { label: 'Post it', completed: false, group: 'publish' },
      {
        label: 'Draft Post #5: Quick win / tip',
        completed: false,
        group: 'create',
      },
      { label: 'Post it', completed: false, group: 'publish' },
      {
        label: 'Draft Post #6: Social proof nugget',
        completed: false,
        group: 'create',
      },
      { label: 'Post it', completed: false, group: 'publish' },
      {
        label: 'Draft Post #7: Direct CTA post',
        completed: false,
        group: 'create',
      },
      { label: 'Post it', completed: false, group: 'publish' },
      {
        label: 'Analyze engagement & note learnings',
        completed: false,
        group: 'followup',
      },
    ],
  ...
  },
  {
    ...
    description:
      '15 targeted DMs/day with a tight script. Start conversations.',
    goal: 'calls',
    duration: 7,
    effortPerDay: '45m',
    outputs: ['DM script', '105 conversations started'],
    hypothesis:
      'If we send 15 targeted DMs per day with personalized hooks, we will book 5+ calls',
    ...
    defaultChecklist: [
      ...
      {
        label: 'Build prospect list (50+ targets)',
        completed: false,
        group: 'setup',
      },
      ...
      { label: 'Send 15 DMs', completed: false, group: 'publish' },
      {
        label: 'Follow-up on Day 1 non-responders',
        completed: false,
        group: 'followup',
      },
      { label: 'Send 15 DMs', completed: false, group: 'publish' },
      ...
      { label: 'Send 15 DMs', completed: false, group: 'publish' },
      {
        label: 'Final follow-ups + analyze results',
        completed: false,
        group: 'followup',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Daily social proof to build trust fast. Turn customer wins into content.',
    goal: 'proof',
    duration: 7,
    effortPerDay: '30m',
    outputs: ['7 social proof posts', '1 long-form case study'],
    hypothesis:
      'If we publish daily customer success content, we will increase trust signals by 50%',
    ...
    defaultChecklist: [
      {
        label: 'Identify 3 customer stories',
        completed: false,
        group: 'setup',
      },
      { label: 'Collect metrics & quotes', completed: false, group: 'setup' },
      {
        label: 'Post: Customer result highlight #1',
        completed: false,
        group: 'publish',
      },
      {
        label: 'Post: Before/after transformation',
        completed: false,
        group: 'publish',
      },
      {
        label: 'Post: Customer quote + context',
        completed: false,
        group: 'publish',
      },
      {
        label: 'Post: Problem → Solution → Result',
        completed: false,
        group: 'publish',
      },
      {
        label: 'Post: Screenshot / video proof',
        completed: false,
        group: 'publish',
      },
      {
        label: 'Post: Customer result highlight #2',
        completed: false,
        group: 'publish',
      },
      {
        label: 'Post: Full case study teaser + CTA',
        completed: false,
        group: 'publish',
      },
      {
        label: 'Write long-form case study',
        completed: false,
        group: 'create',
      },
    ],
  ...
  },
  {
    ...
    hypothesis:
      'If we optimize our landing page messaging, we will increase conversion by 30%',
    ...
    defaultChecklist: [
      ...
      {
        label: 'List top 3 message-match gaps',
        completed: false,
        group: 'setup',
      },
      ...
      {
        label: 'Update social proof section',
        completed: false,
        group: 'create',
      },
      { label: 'Add/update testimonials', completed: false, group: 'create' },
      {
        label: 'Write 3 CTA button variants',
        completed: false,
        group: 'create',
      },
      ...
      {
        label: 'Create A/B test (if applicable)',
        completed: false,
        group: 'setup',
      },
  ...
  },
  {
    ...
    description:
      'Tighten offer + objections + proof. Make your offer irresistible.',
    goal: 'sales',
    duration: 7,
    effortPerDay: '30m',
    outputs: [
    ...
    hypothesis:
      'If we systematically address top objections, we will increase close rate by 25%',
    ...
    defaultChecklist: [
      {
        label: 'Audit current offer positioning',
        completed: false,
        group: 'setup',
      },
      {
        label: 'List common objections (5+)',
        completed: false,
        group: 'setup',
      },
      {
        label: 'Write objection-handling script #1-3',
        completed: false,
        group: 'create',
      },
      {
        label: 'Write objection-handling script #4-5',
        completed: false,
        group: 'create',
      },
      {
        label: 'Create proof points for each objection',
        completed: false,
        group: 'create',
      },
      ...
      {
        label: 'Update pricing presentation',
        completed: false,
        group: 'create',
      },
      {
        label: 'Create comparison chart (if applicable)',
        completed: false,
        group: 'create',
      },
      {
        label: 'Test new messaging in 3 conversations',
        completed: false,
        group: 'publish',
      },
  ...
  },
  {
    ...
    hypothesis:
      'If we host a value-packed webinar, we will book 10+ calls from attendees',
    ...
    defaultChecklist: [
      ...
      {
        label: 'Set date & create registration page',
        completed: false,
        group: 'setup',
      },
      ...
      {
        label: 'Write follow-up email for attendees',
        completed: false,
        group: 'create',
      },
      {
        label: 'Write follow-up email for no-shows',
        completed: false,
        group: 'create',
      },
      ...
      {
        label: 'Analyze results & book calls',
        completed: false,
        group: 'followup',
      },
    ],
...
export function getMovesForContext(
  ...
  // Filter by objective
  let candidates = MOVE_TEMPLATES.filter(
    (m) => !m.allowed_objectives || m.allowed_objectives.includes(objective)
  );
  ...
  const channelMatches = candidates.filter(
    (m) =>
      !m.allowed_channels ||
      m.allowed_channels.some((ch) => channels.includes(ch))
  );
 ...
 */
export function getTemplatesForObjective(
  objective: CampaignObjective
): MoveTemplate[] {
  return MOVE_TEMPLATES.filter(
    (t) => !t.allowed_objectives || t.allowed_objectives.includes(objective)
  );
}
...
export function getTemplatesForChannel(channel: ChannelType): MoveTemplate[] {
  return MOVE_TEMPLATES.filter(
    (t) => !t.allowed_channels || t.allowed_channels.includes(channel)
  );
}
