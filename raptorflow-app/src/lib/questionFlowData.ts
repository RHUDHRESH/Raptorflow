...
export const QUESTIONS: Question[] = [
    ...
    // Q4: ONE metric to brag about
    {
        ...
        options: [
            ...
            { value: 'leads', label: 'Qualified Leads', description: 'Pipeline volume' },
            { value: 'cac', label: 'CAC', description: 'Acquisition cost' },
            { value: 'roas', label: 'ROAS', description: 'Ad spend return' },
            { value: 'activation', label: 'Activation', description: 'User engagement' },
            { value: 'retention', label: 'Retention', description: 'Churn prevention' },
    ...
    // Q5: What are you optimizing for?
    {
        ...
        options: [
            ...
            { value: 'activate', label: 'Activate', description: 'Turn signups into users' },
            { value: 'retain', label: 'Retain', description: 'Keep them coming back' },
            { value: 'monetize', label: 'Monetize', description: 'Convert to revenue' },
            { value: 'expand', label: 'Expand', description: 'Upsell & grow accounts' },
        ],
    },
    ...
    // Q6: What are you selling?
    {
        ...
        options: [
            ...
            { value: 'service', label: 'Service', description: 'Human-delivered work' },
            { value: 'course', label: 'Course', description: 'Education / training' },
            { value: 'marketplace', label: 'Marketplace', description: 'Connecting buyers/sellers' },
    ...
    // Q6b: Service delivery mode (conditional)
    {
        ...
        condition: (data: FoundationData) => data.phase1?.offer?.primaryType === 'service',
        options: [
            { value: 'done-for-you', label: 'Done-for-you', description: 'Full execution' },
            { value: 'done-with-you', label: 'Done-with-you', description: 'Collaborative' },
