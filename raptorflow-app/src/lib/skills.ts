...
export const HOOK_SKILLS: Skill[] = [
  {
    ...
    prompt_template:
      'Start with a hook that highlights a surprising gap between what the audience knows and the truth of the situation.',
  },
  {
    ...
    prompt_template:
      'Challenge a popular but ineffective marketing belief right at the start.',
  },
  {
    ...
    prompt_template:
      'Begin with a raw, honest admission of a past mistake or struggle.',
  },
];
...
export const STRUCTURE_SKILLS: Skill[] = [
  {
    ...
    prompt_template:
      'Structure the message by first identifying a core problem, making its consequences felt, and then presenting the solution.',
  },
  {
    id: 'inverted_pyramid',
    ...
    prompt_template:
      'Put the most critical value proposition in the first sentence, followed by supporting details.',
  },
];
...
export const TONE_SKILLS: Skill[] = [
  {
    ...
    prompt_template:
      'Use a tone that is professional, authoritative, and calm. Avoid hype and excessive punctuation.',
  },
  {
    id: 'direct_surgeon',
    name: 'Direct Surgeon',
    ...
    prompt_template:
      'Write with extreme brevity and precision. Every word must earn its place.',
  },
  {
    ...
    prompt_template:
      'Write as one founder talking to another. Use informal but serious language.',
  },
];
...
export const CTA_SKILLS: Skill[] = [
  {
    ...
    prompt_template:
      'Instead of a link, ask the reader to reply with a specific keyword if they want the next step.',
  },
  {
    id: 'micro_yes_ladder',
    ...
    prompt_template:
      'End with a simple "yes/no" question that is easy to answer and starts a conversation.',
  },
];
