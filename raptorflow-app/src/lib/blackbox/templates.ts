...
export const LEVERS: LeverTemplate[] = [
    ...
    // ==============================
    {
        ...
        hypothesis: 'If we use a question in the subject line, then open rates will increase by 20%',
        control: 'Current subject line format (statement-based)',
        variant: 'Subject line as a direct question the recipient must answer mentally',
    ...
    },
    {
        ...
        hypothesis: 'If we send plain text emails instead of designed HTML, then reply rates will increase by 30%',
    ...
    },
    {
        ...
        hypothesis: 'If we ask for a reply instead of a click, then engagement will increase by 25%',
    ...
    },
    {
        ...
        hypothesis: 'If we cut email length to under 50 words, then click-through rate will increase by 15%',
    ...
    },
    {
        ...
        hypothesis: 'If we personalize the first line with company/role context, then reply rate will double',
    ...
    // ==============================
    {
        ...
        hypothesis: 'If we use value-focused CTA text instead of action text, conversion will increase by 20%',
    ...
    },
    {
        ...
        hypothesis: 'If we add customer count above the fold, conversion will increase by 15%',
    ...
    },
    {
        ...
        hypothesis: 'If we reduce form fields from 5+ to just email, conversion will increase by 40%',
    ...
    },
    {
        ...
        hypothesis: 'If we lead with what they are losing instead of gaining, conversion will increase by 25%',
    ...
    // ==============================
    {
        ...
        hypothesis: 'If we open with a contrarian take, engagement will increase by 50%',
    ...
    },
    {
        ...
        hypothesis: 'If we use carousel format instead of text-only, saves will increase by 3x',
    ...
    },
    {
        ...
        hypothesis: 'If we post threads instead of singles, follower growth will increase by 40%',
    ...
    },
    {
        ...
        hypothesis: 'If we use short video instead of static image, CPA will decrease by 20%',
    ...
    // ==============================
    {
        ...
        hypothesis: 'If we show higher "value" price before actual price, conversion will increase by 20%',
    ...
    },
    {
        ...
        hypothesis: 'If we add a decoy middle tier, pro tier purchases will increase by 30%',
    ...
    // ==============================
    {
        ...
        hypothesis: 'If both referrer and referee get rewards, referral rate will increase by 50%',
    ...
    },
    {
        ...
        hypothesis: 'If we show waitlist position with share-to-jump, signups will increase by 3x',
...
export const CONSTRAINTS: ConstraintTemplate[] = [
    ...
    { id: 'question_only', description: 'Subject is just a question', risk_level: 'spicy' },
    { id: 'lowercase_subject', description: 'All lowercase subject', risk_level: 'spicy' },
    ...
    { id: 'ugly_design', description: 'Deliberately ugly design', risk_level: 'unreasonable' },
    { id: 'no_branding', description: 'Zero branding/logo', risk_level: 'unreasonable' }
];
...
export const CHANNEL_SUGGESTIONS: string[] = [
    'WhatsApp', 'Slack', 'Discord', 'Telegram', 'SMS', 'Push Notifications',
    'Reddit', 'Quora', 'Medium', 'Substack', 'Newsletter', 'Product Hunt',
    'Hacker News', 'Indie Hackers', 'Dev.to', 'Pinterest', 'Snapchat',
    'Clubhouse', 'Twitch', 'Spotify Ads', 'Apple Podcasts', 'Webinar',
    'Conference', 'Meetup', 'Direct Mail', 'Billboard', 'Radio',
    'Print Magazine', 'Newspaper', 'TV', 'Cinema', 'Influencer Partnership',
    'Affiliate', 'Partnership', 'Co-marketing', 'Guest Post', 'Press Release',
    'Review Sites', 'G2', 'Capterra', 'Trustpilot', 'App Store', 'Play Store',
    'Chrome Web Store', 'Marketplace', 'Yelp', 'Google Business', 'LinkedIn Ads',
    'Twitter Ads', 'Programmatic', 'Native Ads', 'Sponsored Content', 'Trade Show'
];
