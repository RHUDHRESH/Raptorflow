...
export const HEURISTICS_LIBRARY: HeuristicTemplate[] = [
  {
    ...
    description:
      'Replacing a statement with a curiosity-driven question in subject lines.',
    principle: 'pattern_interrupt',
    hypothesis_template:
      'If we replace the standard subject line with a question that targets a core pain point, then open rates will increase by 15% because curiosity triggers an immediate dopamine response.',
  ...
  },
  {
    ...
    description:
      'Adding specific numbers to social proof instead of generic claims.',
    principle: 'social_proof',
    hypothesis_template:
      'If we add the specific number of founders using RaptorFlow to the landing page hero, then conversion rate will increase by 10% due to the bandwagon effect.',
    control_placeholder: 'Join hundreds of founders using RaptorFlow.',
    variant_placeholder:
      'Join 1,243 founders who automated their 90-day plan this week.',
  ...
  },
  {
    ...
    description:
      'Using a countdown timer to emphasize what they lose by waiting.',
    principle: 'loss_aversion',
    hypothesis_template:
      'If we include a 24-hour countdown timer for the early-bird offer, then sales will increase by 20% because humans are 2x more motivated to avoid loss than achieve gain.',
    control_placeholder: 'Offer ends soon.',
    variant_placeholder:
      'Offer expires in 23:59:59. Save $200 now or lose it forever.',
  ...
  },
  {
    ...
    principle: 'friction',
    hypothesis_template:
      'If we replace the multi-field signup form with a one-click Google Auth button, then signup completion will increase by 30% by eliminating cognitive load.',
