      ...
      <div className="w-full max-w-[580px] space-y-10">
        ...
        <div className="relative group">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-4 items-center">
            ...
            {/* BEFORE CARD */}
            <div className="bg-[#262626] border border-zinc-800 rounded-2xl p-5 space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm text-zinc-400">What their life looked like before you</label>
                <textarea
                  rows={4}
                  className="w-full bg-[#1a1a1a] border border-zinc-700 rounded-lg px-4 py-3 text-white placeholder:text-zinc-600 focus:outline-none focus:border-red-400 transition-colors resize-none"
            ...
            <div className="flex justify-center md:h-full md:items-center py-2 md:py-0">
              <ArrowRight className="hidden md:block w-6 h-6 text-zinc-600 group-hover:text-[#f59e0b] transition-colors" />
              <ArrowDown className="md:hidden w-6 h-6 text-zinc-600" />
            </div>
            ...
            <div className="bg-[#262626] border border-zinc-800 rounded-2xl p-5 space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm text-zinc-400">What their life looks like after you</label>
                <textarea
                  rows={4}
                  className="w-full bg-[#1a1a1a] border border-zinc-700 rounded-lg px-4 py-3 text-white placeholder:text-zinc-600 focus:outline-none focus:border-green-400 transition-colors resize-none"
        ...
        <div className="space-y-4">
          {!showTip ? (
            ...
            <div className="bg-[#1e1e1e] border-l-2 border-[#f59e0b]/20 p-4 rounded-r-lg space-y-2 animate-in fade-in slide-in-from-left-2 duration-300">
              <p className="text-sm font-bold text-zinc-300 uppercase tracking-widest flex items-center gap-2">
                <span className="text-[#f59e0b]">Pro Tip</span>
              </p>
              <p className="text-sm text-zinc-400 leading-relaxed">
                The best &quot;after&quot; statements are specific and measurable. <span className="text-zinc-200 font-medium italic">&quot;Save time&quot;</span> is weak. <span className="text-green-400 font-medium italic">&quot;Two fewer hours per day on reporting&quot;</span> is strong. <span className="text-zinc-200 font-medium italic">&quot;Feel less stressed&quot;</span> is weak. <span className="text-green-400 font-medium italic">&quot;Know exactly what to post three days ahead&quot;</span> is strong.
              </p>
            </div>
          )}
        </div>
