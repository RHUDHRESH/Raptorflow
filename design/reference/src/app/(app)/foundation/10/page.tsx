...
function AutoWidthInput({ 
  ...
  return (
    <div className="inline-block relative">
      ...
      <input
        className="bg-transparent border-b-2 border-[#f59e0b] text-white text-xl px-1 py-0 outline-none transition-all placeholder:text-zinc-600 focus:border-white"
      ...
      <div className="w-full max-w-[640px] space-y-10">
        ...
        {mode === "builder" ? (
          <div className="space-y-12">
            <div className="text-xl leading-[2.2] text-zinc-300">
            ...
            {/* PREVIEW PANEL */}
            <div className="bg-[#1e1e1e] p-5 rounded-xl border border-zinc-800 space-y-3">
              <label className="text-[10px] uppercase font-bold tracking-widest text-zinc-500">Your positioning statement:</label>
            ...
            <button
              ...
              className="text-sm text-zinc-500 hover:text-white transition-colors underline decoration-zinc-800"
            >
          ...
          <div className="space-y-6">
            <textarea
              autoFocus
              rows={5}
              className="w-full bg-[#262626] border border-zinc-700 rounded-xl px-5 py-4 text-white placeholder:text-zinc-600 focus:outline-none focus:border-[#f59e0b] resize-y"
          ...
          {!showSuggestions ? (
            ...
            <div className="space-y-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
              {[
                ...
                <div key={i} className="p-4 bg-[#262626] border border-zinc-700 rounded-xl flex items-start justify-between gap-4 group">
              ...
              <button onClick={() => setShowSuggestions(false)} className="text-xs text-zinc-600 hover:text-zinc-400">Hide suggestions</button>
            </div>
          )}
        </div>
