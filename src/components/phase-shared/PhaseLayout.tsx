...
export function PhaseLayout({
    ...
    useEffect(() => {
        ...
        tl.to(leftPanelRef.current, { x: 0, opacity: 1, duration: 0.6, ease: 'power3.out' })
            .to(rightPanelRef.current, { opacity: 1, duration: 0.5, ease: 'power2.out' }, '-=0.3')
            .to(contentRef.current, { y: 0, opacity: 1, duration: 0.5, ease: 'power2.out' }, '-=0.3');
    ...
    return (
        <div ref={containerRef} className="flex h-screen overflow-hidden">
            ...
            <div
                ref={rightPanelRef}
                className="flex-1 bg-[#F3F4EE] overflow-y-auto"
            >
