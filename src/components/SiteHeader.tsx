      ...
      >
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex h-20 items-center justify-between">
            {/* Logo Area - Single iconic mark only */}
            <motion.div
              initial={false}
            ...
            >
              <Link to="/" className="flex items-center gap-2">
                <RaptorFlowLogo size="lg" showText={false} animated={true} />
              </Link>
            </motion.div>

            {/* Desktop Nav - Clean monochrome */}
            <nav className="relative hidden items-center gap-1 md:flex p-1 rounded-full border border-zinc-200 bg-white/80 backdrop-blur-md">
              {navItems.map((item) => {
            ...
            <div className="hidden sm:flex items-center gap-4">
              ...
              <Link
                to="/app"
                className="group relative items-center justify-center overflow-hidden rounded-full bg-zinc-900 text-white px-6 py-2.5 text-sm font-bold transition-transform hover:scale-105 hover:bg-black inline-flex shadow-lg"
              >
                <span className="relative z-10 flex items-center gap-2">
                  START NOW <Zap className="w-4 h-4 fill-current" />
                </span>
              </Link>
            </div>
