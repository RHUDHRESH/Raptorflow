  ...
  return (
    <section ref={sectionRef} className="relative py-32 md:py-40 bg-[#050505] overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-amber-950/5 to-transparent" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="lg:sticky lg:top-32 lg:self-start">
            ...
            <motion.p
              ...
              className="mt-6 text-white/35 font-light leading-relaxed max-w-md"
            >
            ...
            >
              <div className="flex -space-x-2">
                {['AM', 'PS', 'VS', 'RK'].map((initials, i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full bg-amber-500/10 border-2 border-[#050505] flex items-center justify-center"
                  >
                    <span className="text-[8px] text-amber-400/70">{initials}</span>
                  </div>
                ))}
              </div>
              <span className="text-xs text-white/30">500+ founders using Raptorflow</span>
            </motion.div>
          </div>
