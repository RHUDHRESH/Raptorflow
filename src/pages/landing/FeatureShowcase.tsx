...
const FeatureOrbit = ({ features, activeFeature, onFeatureChange }) => {
...
const FeatureShowcase = () => {
  ...
  return (
    <section
      ...
      className="relative py-32 md:py-40 bg-background overflow-hidden min-h-screen flex flex-col justify-center perspective-[2000px]"
    >
