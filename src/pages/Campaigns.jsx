            ...
            <div className="border-b border-neutral-200 bg-white">
                <div className="max-w-7xl mx-auto px-6 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="font-serif text-3xl text-neutral-900">Campaigns</h1>
                            <p className="text-neutral-600 mt-1">Strategic campaigns that orchestrate your marketing activities</p>
                        </div>
                        <Link
                            to="/campaigns/new"
