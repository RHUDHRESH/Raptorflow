...
export default function SignupPage() {
    ...
    // Show simple loading state until mounted to avoid hydration mismatch
    if (!isMounted) {
        return (
    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                animate="visible"
            >
                <BlueprintCard figure="FIG. 02" code="AUTH-SIGNUP" showCorners variant="elevated" padding="lg">
                    <motion.div
                    ...
                    >
                        ...
                        <motion.p
                            ...
                            variants={itemVariants}
                        >
                            CREATE YOUR RAPTORFLOW ACCOUNT
                        </motion.p>
                    </motion.div>
                    ...
                    >
                        {[
                            "Setup your marketing OS in 20 minutes",
                            "AI-powered strategy & content generation",
                            "Cancel anytime, no questions asked"
                        ].map((text, index) => (
                            <motion.div
                                key={index}
                                className="flex items-center gap-3 text-sm text-[var(--ink-secondary)]"
                                variants={itemVariants}
                                whileHover={{ x: 4 }}
                    ...
                    >
                        <motion.div variants={itemVariants}>
                            ...
                            >
                                ...
                                {isLoading && clickedButton === 'google' ? "CREATING ACCOUNT..." : "CONTINUE WITH GOOGLE"}
                            </BlueprintButton>
                        </motion.div>
                        ...
                        <motion.div variants={itemVariants}>
                            ...
                            >
                                ...
                                {isLoading && clickedButton === 'github' ? "CREATING ACCOUNT..." : "CONTINUE WITH GITHUB"}
                            </BlueprintButton>
                        </motion.div>
                    </motion.div>
