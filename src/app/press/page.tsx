...
const pressReleases = [
    {
        id: 'blackbox-launch',
        date: '2024-12-15',
        title: 'RaptorFlow Launches Blackbox: Experimental Sandbox for Growth Marketing',
        summary: 'New feature enables founders to test marketing ideas with A/B testing capabilities and gamification elements.',
        category: 'Product Launch',
        downloadUrl: '#',
        featured: true,
        quote: 'Blackbox represents our commitment to helping founders experiment boldly and systematically with their marketing.',
    ...
    },
    {
        id: 'seed-funding',
        date: '2024-11-20',
        title: 'RaptorFlow Raises $2.5M Seed Round to Build Marketing OS for Founders',
        summary: 'Funding will accelerate product development and expand customer success team to serve growing founder community.',
        category: 'Funding',
        downloadUrl: '#',
        featured: false,
        quote: 'This investment validates our vision of systematic marketing for the next generation of founders.',
        author: 'Sarah Chen, CEO',
    ...
    },
    {
        ...
        summary: 'Marketing operating system gains traction among early-stage startups and solo founders seeking systematic approach to growth.',
        category: 'Milestone',
        downloadUrl: '#',
        featured: false,
        quote: 'Reaching 1,000 monthly active founders proves that systematic marketing resonates with the community.',
    ...
    },
    {
        ...
        summary: 'New AI capabilities help founders generate campaign ideas and optimize marketing spend automatically.',
        category: 'Product Update',
        downloadUrl: '#',
        featured: false,
        quote: 'AI is not replacing creativity—it amplifies it by handling the heavy lifting of campaign optimization.',
    ...
    },
    {
        ...
        summary: 'New program enables marketing agencies to serve clients more efficiently using RaptorFlow\'s systematic approach.',
        category: 'Partnership',
        downloadUrl: '#',
        featured: false,
        quote: 'Agencies are force multipliers for our mission to bring systematic marketing to every founder.',
...
const mediaCoverage = [
    {
        ...
        title: 'This startup wants to end "marketing by vibes" with a systematic approach',
        date: '2024-12-10',
        url: '#',
        excerpt: 'RaptorFlow is building what it calls a "marketing operating system" to help founders move from chaotic marketing to systematic execution.',
        author: 'Jordan Smith',
        category: 'Technology',
        featured: true,
    ...
    },
    {
        ...
        date: '2024-11-15',
        url: '#',
        excerpt: 'Featured as Product of the Day, RaptorFlow helps founders build marketing that actually compounds instead of resetting every Monday.',
    ...
    },
    {
        ...
        title: 'From marketing chaos to clarity: How RaptorFlow systematizes growth',
        date: '2024-11-20',
        url: '#',
        excerpt: 'Deep dive into how RaptorFlow helps solo founders and small teams compete with systematic marketing approaches.',
        author: 'Courtney Lee',
        category: 'Startup',
        featured: false,
    ...
    },
    {
        ...
        date: '2024-10-25',
        url: '#',
        excerpt: 'Analysis of how platforms like RaptorFlow are changing the landscape of marketing technology for early-stage companies.',
        author: 'Maria Garcia',
        category: 'Business',
        featured: false,
...
const categories = ['All', 'Product Launch', 'Funding', 'Milestone', 'Product Update', 'Partnership'];
const mediaCategories = ['All', 'Technology', 'Product Launch', 'Startup', 'Business'];
...
export default function PressPage() {
    ...
    const filteredMedia = mediaCoverage.filter(coverage =>
        selectedMediaCategory === 'All' || coverage.category === selectedMediaCategory
    );
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed mb-8">
                            Get the latest news, updates, and media resources about RaptorFlow's mission to help founders build marketing that actually compounds.
                        </p>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                        <div>
                            ...
                            <div className="text-sm text-muted-foreground">Press Mentions</div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="text-sm text-muted-foreground">Product Awards</div>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            ...
                            {featuredRelease && (
                                <div className="rounded-2xl border border-border bg-card p-8 lg:p-12 hover:shadow-lg transition-shadow duration-200">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4">
                                        <Button asChild>
                                            <Link href={featuredRelease.downloadUrl}>Download Press Release</Link>
                                        </Button>
                                    ...
                                    >
                                        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                                            <div className="flex-1">
                                                ...
                                                <h3 className="font-display text-xl font-semibold mb-3">{release.title}</h3>
                    ...
                    {activeTab === 'media' && (
                        <div className="space-y-8">
                                ...
                                <div className="rounded-2xl border border-border bg-card p-8 lg:p-12 hover:shadow-lg transition-shadow duration-200">
                                    ...
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="w-16 h-16 rounded-lg bg-muted flex items-center justify-center">
                                            <span className="text-lg font-bold">{featuredMedia.publication.charAt(0)}</span>
                                        </div>
                                        <div>
                                            <div className="font-semibold text-lg">{featuredMedia.publication}</div>
                                            <div className="text-sm text-muted-foreground">{featuredMedia.date}</div>
                                        </div>
                                    </div>
                                    <h2 className="font-display text-3xl lg:text-4xl font-medium mb-4">
                                        {featuredMedia.title}
                            ...
                            {/* Media List */}
                            <div className="space-y-6">
                                {filteredMedia.filter(coverage => !coverage.featured).map((coverage) => (
                                    <div
                                        key={coverage.id}
                                        className="rounded-xl border border-border bg-card p-6 hover:border-foreground/20 transition-all duration-200"
                                    >
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-3 mb-3">
                                                    <div className="w-12 h-12 rounded-lg bg-muted flex items-center justify-center">
                                                        <span className="text-sm font-bold">{coverage.publication.charAt(0)}</span>
                                                    </div>
                                                    <div>
                                                        <div className="font-semibold">{coverage.publication}</div>
                                                        <div className="text-sm text-muted-foreground">{coverage.date}</div>
                                                    </div>
                                                </div>
                                                <h3 className="font-display text-xl font-semibold mb-3">{coverage.title}</h3>
                                                <p className="text-muted-foreground mb-4">{coverage.excerpt}</p>
                                                ...
                                                <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                                                    ...
                                                    <span>•</span>
                                                    <span>{coverage.shares.toLocaleString()} shares</span>
                                                </div>
                                            </div>
                                            <div className="flex flex-col gap-3">
                                                <Button asChild>
                    ...
                    {activeTab === 'assets' && (
                        <div className="space-y-8">
                            <div className="text-center mb-12">
                                <h2 className="font-display text-3xl lg:text-4xl font-medium mb-4">Media Assets</h2>
                                ...
                                {mediaAssets.map((asset) => (
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-4">
                                            <div>
                                                <h3 className="font-display text-xl font-semibold mb-2">{asset.name}</h3>
