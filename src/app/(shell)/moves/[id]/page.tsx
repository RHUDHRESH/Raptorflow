                    ...
                    <BlueprintCard title="Assets & Outputs" code="ASSETS" padding="none" showCorners>
                        <div className="divide-y divide-[var(--border-subtle)]">
                            <div className="p-4 flex items-center gap-3 hover:bg-[var(--canvas)] transition-colors cursor-pointer">
                                <div className="p-2 bg-[var(--blueprint-light)] text-[var(--blueprint)] rounded-[var(--radius-sm)]"><span className="text-base">📄</span></div>
                            ...
                            <div className="p-4 flex items-center gap-3 hover:bg-[var(--canvas)] transition-colors cursor-pointer">
                                <div className="p-2 bg-[var(--canvas)] text-[var(--muted)] rounded-[var(--radius-sm)]"><span className="text-base">🔗</span></div>
                ...
                <div className="space-y-6">
                    ...
                    <BlueprintCard code="TIMER" padding="md" className="bg-[var(--canvas)]">
                        ...
                        <div className="flex gap-2">
                            <button className="flex-1 flex items-center justify-center gap-2 h-8 rounded-[var(--radius-sm)] bg-[var(--blueprint)] text-[var(--paper)] text-xs font-medium"><span>▶️</span></button>
                            <button className="flex-1 flex items-center justify-center gap-2 h-8 rounded-[var(--radius-sm)] border border-[var(--border)] text-[var(--ink)] text-xs font-medium"><span>⏹️</span> Log</button>
                        </div>
                    </BlueprintCard>
                </div>
            </div>
