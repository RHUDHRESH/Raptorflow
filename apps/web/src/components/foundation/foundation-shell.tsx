      ...
      <main className="flex-1 flex flex-col items-center py-20 px-6">
        <GsapBridge stagger={true} className="w-full max-w-2xl">
          <div className="gsap-reveal mb-12">
            <h1 className="font-[family-name:var(--font-display)] text-4xl mb-3 text-[var(--foreground)]">
              {stepTitle}
            </h1>
          ...
          <div className="gsap-reveal space-y-8">{children}</div>
        </GsapBridge>
      </main>
      ...
      <footer className="sticky bottom-0 z-40 bg-[var(--card)] border-t border-[var(--border)] px-6 py-4 flex items-center justify-between">
        <div>
          {prevHref ? (
            <Button
              asChild
              variant="outline"
              className="rounded-none border-[var(--border)] shadow-none h-12 px-6 uppercase tracking-widest text-xs font-mono"
            >
              <Link href={prevHref}>
        ...
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            onClick={onSaveDraft}
            className="rounded-none h-12 px-6 uppercase tracking-widest text-xs font-mono text-[var(--muted-foreground)] hover:text-[var(--foreground)]"
          >
          ...
          <Button
            ...
            className="rounded-none h-12 px-10 uppercase tracking-widest text-xs font-mono bg-[var(--primary)] text-[var(--primary-foreground)] hover:bg-[var(--primary)]/90 border border-[var(--primary)]"
          >
            Save & Continue
          </Button>
        </div>
