  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] flex">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative">
        <div className="absolute top-6 right-6 lg:hidden font-[family-name:var(--font-display)] text-xl font-bold">
          RAPTORFLOW
        </div>
        <GsapBridge className="w-full flex justify-center" stagger={true}>
          <div className="gsap-reveal w-full max-w-md">{children}</div>
        </GsapBridge>
      </div>
    </main>
  );
