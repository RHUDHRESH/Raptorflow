...
const ARTIFACT_TYPES: Record<
  string,
  { label: string; description: string; source: string; significance: string }
> = {
  "website-snapshot": {
    label: "Website Snapshot",
    description:
      "Full-page visual capture of competitor landing page. Detected shift in primary headline and hero offer.",
  ...
  "ad-creative": {
    label: "Ad Creative",
    description:
      "Paid social creative detected on Meta Ad Library. Testing new 'Identity-led' positioning.",
  ...
  "pricing-change": {
    ...
    description:
      "Structural change in pricing tiers detected via automated price-point monitoring.",
...
export default function IntelArtifactPage({
  ...
  const typeKey =
    Object.keys(ARTIFACT_TYPES).find((k) => artifactId.includes(k)) || "website-snapshot";
    ...
    <div className="flex flex-col gap-8 py-2">
      ...
      <header className="flex items-end justify-between border-b-2 border-[var(--foreground)] pb-6">
        ...
        <div className="flex flex-col items-end gap-2">
          <Badge
            className={
              artifact.significance === "critical"
                ? "bg-red-500/10 text-red-500 border-red-500/20"
                : artifact.significance === "high"
          ...
          <section className="border-2 border-[var(--foreground)] bg-black overflow-hidden relative group">
            ...
            <div className="aspect-video bg-[var(--card)] flex flex-col items-center justify-center border-b border-[var(--border)]">
              ...
              <p className="text-[#9A948C] font-mono text-[10px] uppercase tracking-widest">
                Visual Stream Unavailable
              </p>
              <p className="text-[#9A948C] text-[9px] mt-1 font-mono uppercase tracking-[0.2em]">
                Hardware acceleration required for v8 render
              </p>
            </div>
            <div className="p-6 bg-[var(--card)]">
              <h3
                style={{ fontFamily: "'DM Serif Display', serif", fontSize: 24, marginBottom: 12 }}
              >
                Executive Summary
              </h3>
          ...
          <section className="border border-[var(--border)] bg-[var(--card)] p-8 relative">
            ...
            <div className="space-y-6">
              <p className="text-[#2A2622] text-lg font-light leading-relaxed">
                &ldquo;This shift indicates a move toward direct comparison. They are no longer
                competing on features, but on the{" "}
                <span className="text-[var(--indigo-muse)] underline decoration-indigo-500/30">
                  identity gap
                </span>{" "}
                we identified in the last council session. We should expect a structural push on
                their pricing within 14 days.&rdquo;
              </p>
        ...
        <aside className="space-y-6 sticky top-6">
          ...
          <div className="p-6 border border-[#E5DED4] bg-[#FBF8F2] space-y-4">
            ...
            <p className="text-xs text-[#6B655E] leading-relaxed font-mono">
              Detected via: <br />
              <span className="text-[#4A4540]">Scraper_Node_Bombay_Alpha</span>
              <br />
              LATENCY: 44ms
              <br />
