        ...
        <div className="flex-1 space-y-8">
          <AppPageSection title="Organization Profile">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-3">
                ...
                <div className="py-2 text-sm font-mono text-[var(--ink-400)]">
                  {organization?.id || "org_pending"}
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <p className="text-xs font-mono text-[var(--ink-400)]">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="underline hover:text-[var(--ink-900)] transition-colors"
                >
                  Clerk Dashboard
                </a>
              </p>
          ...
          <AppPageSection title="Onboarding">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              ...
              <Link href={"/foundation" as Route} className="btn-secondary">
                Start onboarding
              </Link>
            </div>
          </AppPageSection>
          ...
          <AppPageSection title="Personal Account">
            <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <>
                  {user.imageUrl ? (
                    ...
                    <img
                      ...
                      className="h-16 w-16 rounded-[var(--radius)] grayscale border border-[var(--border)]"
                    />
                  ) : (
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="font-mono text-xs text-[var(--ink-400)]">
              ...
              <button className="btn-secondary">Manage Auth</button>
            </div>
          </AppPageSection>
          ...
          <AppPageSection title="Danger Zone" variant="danger">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-[var(--ink-500)] text-sm max-w-xl">
                This will permanently destroy the foundation, council logs, active campaigns, and
                intelligence streams. This action cannot be undone.
              </p>
