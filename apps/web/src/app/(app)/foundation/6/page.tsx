  ...
  return (
    <div className="flex flex-col items-center px-6 pt-20 pb-24 min-h-screen bg-[#1a1a1a]">
      <div className="w-full max-w-[640px] space-y-10">
        ...
        {/* PRIMARY ICP CARD */}
        <div className="w-full bg-[#262626] border border-zinc-700 rounded-2xl p-6 space-y-8 shadow-xl">
          ...
          <div className="space-y-2">
            ...
            <input
              autoFocus
              className="w-full bg-[#1a1a1a] border border-zinc-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#f59e0b] transition-colors"
              placeholder="e.g. The Growth-Stage D2C Founder"
              value={primary.name}
              onChange={(e) => setPrimary({...primary, name: e.target.value})}
            />
            <p className="text-xs text-zinc-500 italic">A persona name, not a real person&apos;s name.</p>
          </div>

          {/* Industry/Type & Role Grid */}
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Industry / Type</label>
              <input
                className="w-full bg-[#1a1a1a] border border-zinc-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#f59e0b] transition-colors"
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Their title or role</label>
              <input
                className="w-full bg-[#1a1a1a] border border-zinc-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#f59e0b] transition-colors"
          ...
          {/* Their Biggest Pain */}
          <div className="space-y-2">
            <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider">What keeps them up at night?</label>
            <textarea
              rows={3}
              className="w-full bg-[#1a1a1a] border border-zinc-700 rounded-lg px-4 py-3 text-white placeholder:text-zinc-600 focus:outline-none focus:border-[#f59e0b] resize-y transition-colors"
          ...
          <div className="space-y-3">
            <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider">How do they look for solutions like yours?</label>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ? "border-[#f59e0b] bg-[#f59e0b]/10 text-white shadow-[0_0_10px_rgba(245,158,11,0.1)]"
        ...
        <div className="rounded-xl bg-[#1e1e1e] p-5 border-l-2 border-[#f59e0b]/50 space-y-4">
          <div className="space-y-1">
            <h3 className="text-base font-medium text-white">In their own words...</h3>
          ...
          <textarea
            rows={4}
            className="w-full bg-[#1a1a1a] border border-zinc-800 rounded-lg px-4 py-3 text-white placeholder:text-zinc-600 focus:outline-none focus:border-[#f59e0b] resize-y transition-colors"
        ...
        <div className="space-y-8">
          {!showSecondary ? (
            ...
            <div className="p-6 bg-[#262626] border border-zinc-700 rounded-2xl space-y-6 animate-in fade-in slide-in-from-top-4 duration-500">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-bold text-zinc-300 uppercase tracking-widest">Second Customer Persona</h3>
                <button 
                  onClick={() => { setShowSecondary(false); setSecondary({ name: "", industry: "", pain: "" }); }}
                  className="text-[10px] uppercase tracking-widest text-zinc-500 hover:text-red-400 flex items-center gap-1"
                >
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Persona Name</label>
                  <input
                    className="w-full bg-[#1a1a1a] border border-zinc-700 rounded-lg px-4 py-3 text-white focus:outline-none"
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Their Pain</label>
                  <textarea
                    rows={2}
                    className="w-full bg-[#1a1a1a] border border-zinc-700 rounded-lg px-4 py-3 text-white focus:outline-none"
