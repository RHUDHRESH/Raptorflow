      ...
      <div className="w-full max-w-[560px] space-y-10">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2 relative">
            ...
            <textarea
              rows={4}
              maxLength={300}
              className="w-full bg-[#262626] border border-[#D5CBC0] rounded-lg px-4 py-3 text-[#2A2622] placeholder:text-[#9A948C] focus:outline-none focus:border-[#f59e0b] resize-y"
        ...
        <div className="space-y-8">
          {!showSecondary ? (
            ...
            >
              <div className="flex h-5 w-5 items-center justify-center rounded-full border border-[#D5CBC0] group-hover:border-white">
