...
export default function NotFound(): React.ReactElement {
  return (
    <div className="flex min-h-screen bg-[#FBF8F2] items-center justify-center p-8 overflow-hidden relative">
      <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, #D5CBC0 1px, transparent 0)', backgroundSize: '24px 24px' }} />
      ...
      <GsapBridge stagger={true}>
        <div className="gsap-reveal max-w-xl w-full border-2 border-[var(--foreground)] bg-white p-12 relative z-10 text-center">
          ...
          <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 120, lineHeight: 1, margin: 0 }} className="text-[#2A2622] mb-2">
            404
          </h1>
          
          <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: 24 }} className="text-[#6B655E] mb-8 italic">
