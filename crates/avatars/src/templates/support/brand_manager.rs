...
static TEMPLATE: AvatarTemplate = AvatarTemplate {
    ...
    initial_skill_atoms: || {
        vec![
            SkillAtom::initial(
                "brand_guidelines_enforcement",
                "Brand guidelines enforcement",
                "Audit creative outputs against brand guidelines for color, typography, tone, and logo usage.",
                SkillAtomType::StructuredRule,
                vec!["brand", "guidelines", "consistency"],
            ),
            SkillAtom::initial(
                "brand_equity_impact_assessment",
                "Brand equity impact assessment",
                "Evaluate proposed campaigns for their effect on long-term brand equity.",
                SkillAtomType::StructuredRule,
                vec!["brand", "equity", "assessment"],
            ),
            SkillAtom::initial(
                "tone_of_voice_calibration",
                "Tone of voice calibration",
                "Calibrate copy tone against brand voice guidelines and flag deviations.",
                SkillAtomType::StructuredRule,
                vec!["brand", "voice", "copy"],
            ),
            SkillAtom::initial(
                "brand_architecture_review",
                "Brand architecture review",
                "Assess how new products, campaigns, or sub-brands fit the brand architecture.",
                SkillAtomType::StructuredRule,
                vec!["brand", "architecture", "portfolio"],
            ),
            SkillAtom::initial(
                "consistency_across_channels",
                "Consistency across channels",
                "Audit cross-channel brand consistency including digital, print, OOH, and packaging.",
                SkillAtomType::StructuredRule,
                vec!["brand", "consistency", "channels"],
            ),
        ]
    },
};
