    ...
    initial_skill_atoms: || {
        vec![
            SkillAtom::initial(
                ...
                "Check campaign outputs against brand guidelines across all executions for color, typography, tone, and logo usage.",
                SkillAtomType::StructuredRule,
                vec!["brand", "consistency", "qa"],
            ),
            SkillAtom::initial(
                "quality_checklist_design",
                "Quality checklist design",
                "Design pre-release checklists for content, legal, brand, and accuracy reviews.",
                SkillAtomType::StructuredRule,
                vec!["qa", "checklist", "process"],
            ),
            SkillAtom::initial(
                "error_classification",
                "Error classification",
                "Classify errors by severity (blocking/major/minor) and assign remediation priority.",
                SkillAtomType::StructuredRule,
                vec!["qa", "error", "classification"],
            ),
            SkillAtom::initial(
                "brief_ambiguity_resolution",
                "Brief ambiguity resolution",
                "Identify underspecified requirements in briefs before production begins.",
                SkillAtomType::StructuredRule,
                vec!["brief", "qa", "clarification"],
            ),
            SkillAtom::initial(
                "cross_execution_consistency",
                "Cross-execution consistency",
                "Audit consistency of messaging, visual identity, and tone across all campaign executions.",
                SkillAtomType::StructuredRule,
                vec!["consistency", "campaign", "brand"],
            ),
        ]
    },
};
