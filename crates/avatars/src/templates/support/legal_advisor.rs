...
static TEMPLATE: AvatarTemplate = AvatarTemplate {
    ...
    initial_skill_atoms: || {
        vec![
            SkillAtom::initial(
                "claims_substantiation_audit",
                "Claims substantiation audit",
                "Evaluate advertising claims for substantiation requirements and proof standards by jurisdiction.",
                SkillAtomType::StructuredRule,
                vec!["legal", "claims", "advertising"],
            ),
            SkillAtom::initial(
                "ip_clearance_checklist",
                "IP clearance checklist",
                "Design pre-production IP clearance checklists for copy, images, music, and talent usage.",
                SkillAtomType::StructuredRule,
                vec!["legal", "ip", "clearance"],
            ),
            SkillAtom::initial(
                "data_privacy_compliance",
                "Data privacy compliance",
                "Assess data collection practices against GDPR, CCPA, and applicable privacy regulations.",
                SkillAtomType::StructuredRule,
                vec!["legal", "privacy", "compliance"],
            ),
            SkillAtom::initial(
                "comparative_advertising_rules",
                "Comparative advertising rules",
                "Apply comparative advertising legal standards by jurisdiction.",
                SkillAtomType::StructuredRule,
                vec!["legal", "comparative", "advertising"],
            ),
            SkillAtom::initial(
                "regulatory_risk_classification",
                "Regulatory risk classification",
                "Score campaign elements by regulatory risk level and recommend mitigation strategies.",
                SkillAtomType::StructuredRule,
                vec!["legal", "risk", "regulation"],
            ),
        ]
    },
};
