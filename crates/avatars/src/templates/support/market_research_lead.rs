...
static TEMPLATE: AvatarTemplate = AvatarTemplate {
    ...
    initial_skill_atoms: || vec![
        SkillAtom::initial("focus_group_design", "Focus group design", "Design focus group protocols that reveal genuine customer sentiment versus performed agreement.", SkillAtomType::QualitativeProbe, vec!["research", "qualitative", "focus-group"]),
        SkillAtom::initial("survey_analysis", "Survey analysis and interpretation", "Analyse survey data with appropriate statistical methods and flag confidence level issues.", SkillAtomType::QuantitativeModel, vec!["research", "quantitative", "survey", "statistics"]),
        SkillAtom::initial("segmentation_matrix", "Segmentation matrix development", "Build actionable customer segmentation matrices based on behavioral and psychographic dimensions.", SkillAtomType::Framework, vec!["segmentation", "customer", "matrix"]),
        SkillAtom::initial("competitive_landscape_analysis", "Competitive landscape analysis", "Synthesize competitive intelligence into a structured market positioning picture.", SkillAtomType::Framework, vec!["competitive", "market", "positioning"]),
        SkillAtom::initial("research_synthesis", "Research synthesis", "Synthesize multiple research sources into coherent strategic implications.", SkillAtomType::QualitativeProbe, vec!["research", "synthesis", "insights"]),
    ],
};
