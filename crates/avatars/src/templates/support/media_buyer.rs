    ...
    initial_skill_atoms: || {
        vec![
            SkillAtom::initial(
                ...
                "Manage programmatic campaigns across DSPs with real-time bidding optimisation.",
                SkillAtomType::TechnicalProcess,
                vec!["programmatic", "DSP", "RTB", "media"],
            ),
            SkillAtom::initial(
                "frequency_optimisation",
                "Frequency optimisation",
                "Monitor and cap impression frequency to prevent waste and creative fatigue.",
                SkillAtomType::TechnicalProcess,
                vec!["frequency", "impressions", "fatigue"],
            ),
            SkillAtom::initial(
                "attribution_modelling",
                "Attribution modelling",
                "Build multi-touch attribution models to connect media spend to business outcomes.",
                SkillAtomType::QuantitativeModel,
                vec!["attribution", "media", "conversion", "modelling"],
            ),
            SkillAtom::initial(
                "viewability_validation",
                "Viewability validation",
                "Validate that impressions are in-view and brand-safe before counting them.",
                SkillAtomType::TechnicalProcess,
                vec!["viewability", "brand-safety", "media-quality"],
            ),
            SkillAtom::initial(
                "audience_audit",
                "Audience overlap audit",
                "Identify and eliminate audience overlap across platforms to prevent double spending.",
                SkillAtomType::Framework,
                vec!["audience", "overlap", "targeting", "media"],
            ),
        ]
    },
};
