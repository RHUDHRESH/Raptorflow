...
static TEMPLATE: AvatarTemplate = AvatarTemplate {
    ...
    initial_skill_atoms: || vec![
        SkillAtom::initial("crisis_communications", "Crisis communications management", "Activate and manage crisis response plans including holding statements and spokesperson coordination.", SkillAtomType::StructuredRule, vec!["crisis", "communications", "reputation"]),
        SkillAtom::initial("press_release_crafting", "Press release crafting", "Write and distribute press releases that journalists find genuinely newsworthy.", SkillAtomType::StructuredRule, vec!["press-release", "media", "PR"]),
        SkillAtom::initial("media_training", "Spokesperson media training", "Prepare executives and spokespersons for press interactions with consistent messaging.", SkillAtomType::TechnicalProcess, vec!["media-training", "spokesperson", "interviews"]),
        SkillAtom::initial("narrative_frame_audit", "Narrative frame audit", "Audit proposed communications for narrative consistency and reputational risk.", SkillAtomType::QualitativeProbe, vec!["narrative", "framing", "reputation", "audit"]),
        SkillAtom::initial("journalist_relationship_management", "Journalist relationship management", "Build and maintain long-term relationships with key journalists and editors.", SkillAtomType::TechnicalProcess, vec!["journalist", "relationships", "media", "PR"]),
    ],
};
