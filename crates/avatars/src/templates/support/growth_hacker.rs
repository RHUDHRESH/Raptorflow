    ...
    initial_skill_atoms: || {
        vec![
            SkillAtom::initial(
                "viral_loop_design",
                "Viral loop design",
                "Design product features that create natural sharing incentives and network effects.",
                SkillAtomType::Framework,
                vec!["viral", "growth", "network-effect", "referral"],
            ),
            SkillAtom::initial(
                "referral_program_design",
                "Referral program design",
                "Design and optimise referral programs with appropriate incentives for both referrer and referee.",
                SkillAtomType::Framework,
                vec!["referral", "program", "growth"],
            ),
            SkillAtom::initial(
                "activation_funnel_optimisation",
                "Activation funnel optimisation",
                "Identify and fix drop-off points in the user activation funnel to reach the aha moment.",
                SkillAtomType::TechnicalProcess,
                vec!["activation", "funnel", "optimisation", "retention"],
            ),
            SkillAtom::initial(
                "retention_cohort_analysis",
                "Retention cohort analysis",
                "Analyse retention curves by cohort to identify what differentiates retained from churned users.",
                SkillAtomType::QuantitativeModel,
                vec!["retention", "cohort", "churn", "analysis"],
            ),
            SkillAtom::initial(
                "growth_experiment_design",
                "Growth experiment design",
                "Design rigorous A/B and multivariate experiments with appropriate sample size and success metrics.",
                SkillAtomType::TechnicalProcess,
                vec!["experiment", "A/B", "growth", "testing"],
            ),
        ]
    },
};
