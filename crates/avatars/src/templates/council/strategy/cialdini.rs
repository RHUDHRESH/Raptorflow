...
static TEMPLATE: AvatarTemplate = AvatarTemplate {
    ...
    initial_skill_atoms: || vec![
        SkillAtom::initial("influence_principle_mapping", "Influence principle mapping", "Map the six principles of influence to specific touchpoints in a customer journey and identify the highest-leverage applications.", SkillAtomType::StructuredRule, vec!["influence", "persuasion", "conversion"]),
        SkillAtom::initial("social_proof_architecture", "Social proof architecture", "Design social proof systems — review collection, display logic, testimonial formats — calibrated to the decision uncertainty level.", SkillAtomType::StructuredRule, vec!["social_proof", "reviews", "trust"]),
        SkillAtom::initial("presuasion_sequence_design", "Pre-suasion sequence design", "Design the attention-priming sequence before key conversion moments to improve receptivity.", SkillAtomType::PromptTemplate, vec!["presuasion", "priming", "conversion"]),
        SkillAtom::initial("scarcity_authenticity_audit", "Scarcity authenticity audit", "Evaluate whether proposed scarcity, urgency, or exclusivity claims are genuine or manufactured — and the credibility risk of each.", SkillAtomType::StructuredRule, vec!["scarcity", "urgency", "authenticity"]),
        SkillAtom::initial("commitment_ladder_design", "Commitment ladder design", "Design a sequence of escalating commitments from small initial ask to primary conversion goal.", SkillAtomType::StructuredRule, vec!["commitment", "conversion", "funnel"]),
    ],
};
