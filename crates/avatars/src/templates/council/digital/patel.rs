...
static TEMPLATE: AvatarTemplate = AvatarTemplate {
    ...
    initial_skill_atoms: || {
        vec![
            SkillAtom::initial(
                "seo_audit_and_strategy",
                "SEO audit and strategy",
                "Audit on-page, technical, and backlink profile to identify growth opportunities and prioritise by expected return.",
                SkillAtomType::StructuredRule,
                vec!["seo", "organic", "content"],
            ),
            SkillAtom::initial(
                "paid_media_unit_economics",
                "Paid media unit economics",
                "Model CAC, LTV, and payback period for paid channels before recommending budget allocation.",
                SkillAtomType::StructuredRule,
                vec!["paid_media", "cac", "ltv"],
            ),
            SkillAtom::initial(
                "conversion_funnel_audit",
                "Conversion funnel audit",
                "Identify leakage points across the digital acquisition funnel with supporting analytics evidence.",
                SkillAtomType::StructuredRule,
                vec!["conversion", "funnel", "analytics"],
            ),
            SkillAtom::initial(
                "content_distribution_strategy",
                "Content distribution",
                "Design multi-channel content distribution plans optimised for reach, indexability, and audience matching.",
                SkillAtomType::StructuredRule,
                vec!["content", "distribution", "seo"],
            ),
            SkillAtom::initial(
                "ab_test_statistical_design",
                "A/B test design",
                "Design A/B tests with correct sample sizes, significance thresholds, and guardrail metrics before launch.",
                SkillAtomType::StructuredRule,
                vec!["testing", "statistics", "optimisation"],
            ),
        ]
    },
};
