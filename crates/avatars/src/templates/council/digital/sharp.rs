...
static TEMPLATE: AvatarTemplate = AvatarTemplate {
    ...
    initial_skill_atoms: || {
        vec![
            SkillAtom::initial(
                "mental_availability_audit",
                "Mental availability audit",
                "Assess how many category entry points the brand owns and identify gaps in competitive context.",
                SkillAtomType::StructuredRule,
                vec!["mental_availability", "brand", "category"],
            ),
            SkillAtom::initial(
                "distinctive_asset_analysis",
                "Distinctive asset analysis",
                "Evaluate the strength, uniqueness, and consistency of a brand's distinctive asset portfolio.",
                SkillAtomType::StructuredRule,
                vec!["distinctive_assets", "brand", "memorability"],
            ),
            SkillAtom::initial(
                "penetration_vs_loyalty_diagnosis",
                "Penetration diagnosis",
                "Diagnose whether a brand's growth challenge is a penetration problem or a loyalty problem using purchase data.",
                SkillAtomType::StructuredRule,
                vec!["penetration", "loyalty", "growth"],
            ),
            SkillAtom::initial(
                "double_jeopardy_benchmarking",
                "Double jeopardy benchmarking",
                "Apply the double jeopardy law to benchmark a brand's buyer frequency against its category share.",
                SkillAtomType::StructuredRule,
                vec!["double_jeopardy", "category", "benchmarking"],
            ),
            SkillAtom::initial(
                "reach_planning_principles",
                "Reach planning principles",
                "Design media plans that maximise unduplicated reach across the full category, not just the existing customer base.",
                SkillAtomType::StructuredRule,
                vec!["reach", "media_planning", "penetration"],
            ),
        ]
    },
};
