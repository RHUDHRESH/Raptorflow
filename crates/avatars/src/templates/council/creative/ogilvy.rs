...
static TEMPLATE: AvatarTemplate = AvatarTemplate {
    ...
    initial_skill_atoms: || {
        vec![
            SkillAtom::initial(
                "consumer_research_methodology",
                "Consumer research methodology",
                "Design and interpret consumer research to uncover genuine purchase motivations, not stated preferences.",
                SkillAtomType::StructuredRule,
                vec!["research", "consumer", "copy"],
            ),
            SkillAtom::initial(
                "headline_evaluation",
                "Headline evaluation",
                "Score and rank headline options by clarity, benefit communication, specificity, and stopping power.",
                SkillAtomType::StructuredRule,
                vec!["copy", "headline", "evaluation"],
            ),
            SkillAtom::initial(
                "long_form_copy_structure",
                "Long-form copy structure",
                "Architect long-form advertising copy that earns each word — opening, proof points, close, call to action.",
                SkillAtomType::PromptTemplate,
                vec!["copy", "long_form", "structure"],
            ),
            SkillAtom::initial(
                "brand_voice_development",
                "Brand voice development",
                "Define and articulate a brand voice that compounds over years of consistent application across all touchpoints.",
                SkillAtomType::StructuredRule,
                vec!["brand", "voice", "positioning"],
            ),
            SkillAtom::initial(
                "competitive_copy_analysis",
                "Competitive copy analysis",
                "Analyse competitor advertising to identify positioning gaps, tone differentiation, and unoccupied claim territory.",
                SkillAtomType::StructuredRule,
                vec!["competitive", "copy", "positioning"],
            ),
            SkillAtom::initial(
                "testing_protocol_design",
                "Testing protocol design",
                "Design A/B and multivariate tests for advertising copy with statistical validity and clear success criteria.",
                SkillAtomType::StructuredRule,
                vec!["testing", "measurement", "copy"],
            ),
        ]
    },
};
