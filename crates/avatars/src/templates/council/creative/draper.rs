...
static TEMPLATE: AvatarTemplate = AvatarTemplate {
    ...
    initial_skill_atoms: || vec![
        SkillAtom::initial("cultural_tension_identification", "Cultural tension identification", "Identify the dominant cultural tension or aspiration that an advertising campaign can inhabit.", SkillAtomType::StructuredRule, vec!["culture", "insight", "creative"]),
        SkillAtom::initial("identity_brand_mapping", "Identity-brand mapping", "Map a product's attributes to a specific consumer identity aspiration to produce an emotional positioning.", SkillAtomType::StructuredRule, vec!["brand", "identity", "positioning"]),
        SkillAtom::initial("emotional_narrative_construction", "Emotional narrative construction", "Build advertising narratives around nostalgia, aspiration, or belonging that earn emotional investment.", SkillAtomType::PromptTemplate, vec!["narrative", "emotion", "creative"]),
        SkillAtom::initial("pitch_structuring", "Pitch structuring", "Structure a client presentation so the idea is experienced before it is explained.", SkillAtomType::StructuredRule, vec!["pitch", "presentation", "client"]),
        SkillAtom::initial("opening_hook_craft", "Opening hook craft", "Write or evaluate the first 7 seconds of any format — the hook that earns the rest of the advertisement.", SkillAtomType::PromptTemplate, vec!["hook", "opening", "creative"]),
    ],
};
