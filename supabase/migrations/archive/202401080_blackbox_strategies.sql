...
CREATE INDEX IF NOT EXISTS idx_blackbox_strategies_tags ON public.blackbox_strategies USING GIN (tags jsonb_path_ops);
CREATE INDEX IF NOT EXISTS idx_blackbox_strategies_keywords ON public.blackbox_strategies USING GIN (keywords jsonb_path_ops);
CREATE INDEX IF NOT EXISTS idx_blackbox_strategies_attributes ON public.blackbox_strategies USING GIN (attributes jsonb_path_ops);
