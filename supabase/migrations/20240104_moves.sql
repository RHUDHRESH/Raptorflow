...
CREATE INDEX IF NOT EXISTS idx_moves_category ON public.moves(category);
CREATE INDEX IF NOT EXISTS idx_moves_tags ON public.moves USING GIN (tags) WITH (jsonb_path_ops);
CREATE INDEX IF NOT EXISTS idx_moves_status ON public.moves(status);
CREATE INDEX IF NOT EXISTS idx_moves_priority ON public.moves(priority);
CREATE INDEX IF NOT EXISTS idx_moves_target_date ON public.moves(target_date);
CREATE INDEX IF NOT EXISTS idx_moves_created_at ON public.moves(created_at DESC);
