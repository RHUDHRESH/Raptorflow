...
-- Tags index
CREATE INDEX IF NOT EXISTS idx_muse_assets_tags ON public.muse_assets USING GIN (tags jsonb_path_ops);
CREATE INDEX IF NOT EXISTS idx_muse_assets_keywords ON public.muse_assets USING GIN (keywords jsonb_path_ops);
CREATE INDEX IF NOT EXISTS idx_muse_assets_attributes ON public.muse_assets USING GIN (attributes jsonb_path_ops);
