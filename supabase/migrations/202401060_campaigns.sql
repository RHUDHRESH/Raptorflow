...
-- Tags index
CREATE INDEX IF NOT EXISTS idx_campaigns_tags ON public.campaigns USING GIN (tags jsonb_path_ops);
CREATE INDEX IF NOT EXISTS idx_campaigns_channels ON public.campaigns USING GIN (channels jsonb_path_ops);
CREATE INDEX IF NOT EXISTS idx_campaigns_target_metrics ON public.campaigns USING GIN (target_metrics jsonb_path_ops);
