...
- [x] Task: Audit `StatsBar` and `RiskSlider` against real backend data ranges [a6d4613]
- [x] Task: Remove orphan UI elements lacking backend logic [a6d4613]
- [x] Task: Final Style & Motion Polish (Framer Motion check) [a6d4613]
- [x] Task: Conductor - User Manual Verification 'UI Audit & Decisive Cleanup' (Protocol in workflow.md)
