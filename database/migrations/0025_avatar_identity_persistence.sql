...
CREATE TABLE IF NOT EXISTS avatar_identity_states (
    ...
    mood_skepticism NUMERIC NOT NULL DEFAULT 0.5 CHECK (mood_skepticism >= 0.0 AND mood_confidence <= 1.0),
    mood_creativity NUMERIC NOT NULL DEFAULT 0.5 CHECK (mood_creativity >= 0.0 AND mood_confidence <= 1.0),
    mood_urgency NUMERIC NOT NULL DEFAULT 0.5 CHECK (mood_urgency >= 0.0 AND mood_confidence <= 1.0),
