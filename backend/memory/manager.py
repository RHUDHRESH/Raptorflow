...
class MemoryManager:
    ...
    async def store_trace(
        ...
        try:
            ...
            if important:
                logger.info(
                    f"Storing important trace from thread {thread_id} in L2 episodic memory."
                )
    ...
    async def retrieve_context(
        ...
        try:
            ...
            context["episodic"] = await self.l2.recall_similar(
                workspace_id, query_embedding, limit=3
            )
