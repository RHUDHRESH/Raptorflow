...
class L3SemanticMemory:
    ...
    async def search_foundation(
        ...
        try:
            ...
            logger.info(f"L3 Foundation Search: found {len(formatted_results)} results for {workspace_id}")
    ...
    async def remember_foundation(
        ...
        try:
            ...
            logger.info(f"L3 Foundation Fact stored: {fact_id} for workspace {workspace_id}")
            return fact_id
        except Exception as e:
