...
async def health_check() -> Dict[str, Any]:
    """Basic health check"""
    return {"status": "healthy", "service": "raptorflow-backend", "version": "1.0.0"}
...
async def detailed_health() -> Dict[str, Any]:
    ...
    return {
        ...
        "database": "connected",
        "redis": "connected",
        "services": {"database": "ok", "cache": "ok", "llm": "ok"},
    }
...
async def get_current_user() -> Dict[str, Any]:
    ...
    return {"id": "mock_user", "email": "mock@example.com", "name": "Mock User"}
...
async def generate_strategy() -> Dict[str, Any]:
    ...
    return {"strategy": "mock_strategy", "confidence": 0.85}
...
async def get_analytics() -> Dict[str, Any]:
    """Mock analytics data"""
    return {"metrics": {"users": 100, "campaigns": 25, "conversion_rate": 0.15}}
...
async def process_ocr() -> Dict[str, Any]:
    """Mock OCR processing"""
    return {"text": "mock_extracted_text", "confidence": 0.92}
