        ...
        metrics = {
            ...
            "performance": {
                ...
                "operations_per_second": (
                    round(1000 / response_time) if response_time > 0 else 0
                ),
            },
            "memory": {
...
async def test_redis_operations(test_data: Optional[Dict[str, Any]] = None):
    ...
    try:
        ...
        return {
            ...
            "summary": {
                ...
                "average_response_time_ms": round(
                    sum(r["response_time_ms"] for r in results.values()) / len(results),
                    2,
                ),
            },
        }
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to test Redis operations: {str(e)}"
        )
