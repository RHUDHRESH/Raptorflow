...
async def predict_scaling() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "success",
            "data": {"next_hour": next_hour, "daily": daily, "timestamp": "current"},
        }
...
async def get_recommendations() -> Dict[str, Any]:
    ...
    try:
        ...
        recommendations = await scaling_engine._get_contextual_recommendations(
            load_data
        )
...
async def get_automation_metrics() -> Dict[str, Any]:
    ...
    try:
        ...
        metrics = {
            ...
            "scaling": {
                ...
                "scale_up_events": len(
                    [
                        s
                        for s in scaling_engine.scaling_history
                        if "scale_up" in s.get("action", "")
                    ]
                ),
            ...
            "performance": {
                ...
                "baseline_load": scaling_status.get("patterns", {}).get(
                    "baseline_load", 0.0
                ),
            },
        }
        ...
        if scaling_engine.load_history:
            ...
            metrics["performance"]["avg_utilization"] = sum(utilizations) / len(
                utilizations
            )
