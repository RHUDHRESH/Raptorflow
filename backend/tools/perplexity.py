...
class PerplexitySearchTool(BaseRaptorTool):
    ...
    async def _execute(
        ...
        try:
            ...
            search_results = self._generate_mock_perplexity_results(
                query, search_mode, max_results
            )

            # Format results based on search mode
            if search_mode == "comprehensive":
                return self._format_comprehensive_results(
                    search_results, include_citations
                )
    ...
    def _generate_mock_perplexity_results(
    ...
    def _format_comprehensive_results(
        self, results: Dict[str, Any], include_citations: bool
    ) -> Dict[str, Any]:
    ...
    def _format_academic_results(self, results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        academic_sources = [
            s for s in results["sources"] if s["credibility"] in ["high", "very_high"]
        ]
