...
class SocialMediaManagerTool(BaseRaptorTool):
    ...
    async def _post_social_content(
        ...
        post_results["predictions"] = {
            ...
            "best_performing_platform": self._predict_best_platform(
    ...
    async def _schedule_social_posts(
        self, content_data: Dict[str, Any], platforms: List[str]
    ) -> Dict[str, Any]:
        ...
        schedule_data["schedule_summary"] = {
            ...
            "first_post_time": (
                schedule_data["posts"][0]["scheduled_time"]
                if schedule_data["posts"]
                else None
            ),
            "last_post_time": (
                schedule_data["posts"][-1]["scheduled_time"]
                if schedule_data["posts"]
                else None
            ),
    ...
    async def _manage_community(self, filters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"success": True, "data": community_data, "action": "manage_community"}
    ...
    async def _optimize_content(
        ...
        scores = [
            ...
            for opt in optimization["platform_optimizations"].values()
        ]
    ...
    async def _analyze_trends(self, filters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"success": True, "data": trends_data, "action": "trend_analysis"}
    ...
    def _optimize_for_platform(
        ...
        optimizations = {
            "twitter": {"max_chars": 280, "hashtags": 2, "mentions": 1},
            "linkedin": {"max_chars": 3000, "hashtags": 3, "mentions": 5},
            "facebook": {"max_chars": 8000, "hashtags": 3, "mentions": 10},
            "instagram": {"max_chars": 2200, "hashtags": 5, "mentions": 5},
        }
        ...
        hashtags = self._generate_hashtags(
            content_data.get("topic", ""), platform_rules["hashtags"]
        )
        ...
        return {
            ...
            "optimization_score": self._calculate_optimization_score(
                optimized_text, hashtags, mentions, platform
            ),
        }
    ...
    def _calculate_optimization_score(
        self, text: str, hashtags: List[str], mentions: List[str], platform: str
    ) -> float:
    ...
    def _analyze_content_variety(self, posts: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        variety_score = len(
            set(post.get("content_type", "text") for post in posts)
        ) / len(content_types)

        return {
            "variety_score": variety_score,
            "content_types_used": list(
                set(post.get("content_type", "text") for post in posts)
            ),
            "recommendation": (
                "Add more content variety"
                if variety_score < 0.5
                else "Good content variety"
            ),
        }

    def _generate_post_optimizations(
        self, post: Dict[str, Any], platforms: List[str]
    ) -> Dict[str, Any]:
