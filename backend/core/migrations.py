...
class MigrationManager:
                ...
                async with conn.cursor() as cur:
                    for migration in pending:
                        try:
                            ...
                            # Record migration
                            execution_time = int(
                                (datetime.utcnow() - migration_start).total_seconds() * 1000
                            )
    ...
    async def get_migration_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "current_version": max(self.applied_migrations.keys()) if self.applied_migrations else None,
    ...
    async def verify_migration_integrity(self) -> Dict[str, Any]:
        ...
        for version, info in self.applied_migrations.items():
            if version in self.migrations:
                ...
                integrity_issues.append({
                    "version": version,
                    "issue": "Migration definition missing"
                })
