...
class MilestoneTracker:
    ...
    @staticmethod
    def audit_milestones(milestones: List[Dict[str, Any]], completed_tasks: List[str]) -> List[MilestoneStatus]:
        ...
        for ms in milestones:
            ...
            is_done = any(ms['title'].lower() in task.lower() for task in completed_tasks)
