...
class CacheEntry:
    ...
    def access(self) -> Any:
        ...
        if time_diff_hours > 0:
            ...
            self.access_frequency = (alpha * new_frequency + (1 - alpha) * self.access_frequency)
...
class L1MemoryCache:
    ...
    def _update_memory_usage(self, delta_bytes: int):
        ...
        self._total_memory_bytes = max(0, self._total_memory_bytes)  # Ensure non-negative
...
class ComprehensiveCacheManager:
    ...
    async def invalidate_pattern(self, pattern: str) -> int:
        ...
        try:
            ...
            await self._emit_event("cache_invalidate", {"pattern": pattern, "count": len(l1_keys) + l2_count})
    ...
    def get_comprehensive_stats(self) -> Dict[str, Any]:
        ...
        overall_hit_rate = self._total_hits / total_requests if total_requests > 0 else 0
