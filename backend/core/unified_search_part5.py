...
class ErrorClassifier:
    ...
    def __init__(self):
        self.error_patterns = {
            ...
            ErrorType.TIMEOUT_ERROR: ["timeout", "timed out", "deadline", "time limit"],
            ErrorType.RATE_LIMIT_ERROR: [
                "rate limit",
                "too many requests",
                "quota exceeded",
    ...
    def _determine_severity(
        self, error_type: ErrorType, exception: Exception, context: Dict[str, Any]
    ) -> ErrorSeverity:
    ...
    async def execute_with_fault_tolerance(
        ...
        **kwargs,
        ...
        return await self._try_fallback_providers(
            provider, func, query, *args, **kwargs
        )
        ...
        **kwargs,
        ...
        for fallback_provider in fallbacks:
            ...
            try:
                ...
                logger.warning(
                    f"Fallback provider {fallback_provider} also failed: {e}"
                )
                continue
...
class HealthChecker:
    ...
    async def check_provider_health(self, provider: SearchProvider) -> Dict[str, Any]:
        ...
        try:
            ...
            health_info.update({"status": "unhealthy", "error_message": str(e)})
    ...
    def get_system_health(self) -> Dict[str, Any]:
        ...
        healthy_count = sum(
            1 for info in self.health_status.values() if info["status"] == "healthy"
        )
