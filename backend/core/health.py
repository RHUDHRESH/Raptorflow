...
class SystemHealth:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        healthy_percentage = (check_counts["healthy"] / total_checks * 100) if total_checks > 0 else 0
...
class HealthMonitor:
    ...
    async def _run_single_check(self, name: str, check_func: Callable, start_time: float) -> HealthCheck:
