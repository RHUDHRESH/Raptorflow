...
class MarketingFrameworks:
    PAS = {
        ...
        "instructions": "1. Start with a visceral description of the problem. 2. Agitate the consequences of inaction. 3. Present the solution as the only logical exit."
    }
    AIDA = {
        "name": "Attention-Interest-Desire-Action",
        "description": "Classic conversion framework.",
        "instructions": "1. Hook with a data point. 2. Build interest with a 'how-to'. 3. Create desire with social proof. 4. Force action with urgency."
    }
    BAB = {
        "name": "Before-After-Bridge",
        "description": "Contrast based storytelling.",
        "instructions": "1. Describe the messy 'Before' state. 2. Describe the perfect 'After' state. 3. Bridge the gap with the product."
    }
