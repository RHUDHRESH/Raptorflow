...
async def track_onboarding_completed(user_id: str, properties: Optional[Dict[str, Any]] = None) -> bool:
...
async def track_payment_initiated(user_id: str, properties: Optional[Dict[str, Any]] = None) -> bool:
...
async def track_payment_completed(user_id: str, properties: Optional[Dict[str, Any]] = None) -> bool:
...
async def track_icp_created(user_id: str, properties: Optional[Dict[str, Any]] = None) -> bool:
    """Track ICP creation"""
    client = get_posthog_client()
    return await client.capture_event(
        distinct_id=user_id,
        event_name="ICP_CREATED",
        properties=properties
    )


async def track_campaign_created(user_id: str, properties: Optional[Dict[str, Any]] = None) -> bool:
...
async def track_agent_used(user_id: str, agent_name: str, properties: Optional[Dict[str, Any]] = None) -> bool:
    """Track agent usage"""
    client = get_posthog_client()
    ...
    return await client.capture_event(
        distinct_id=user_id,
        event_name="AGENT_USED",
        properties=event_properties
    )


async def track_feature_used(user_id: str, feature_name: str, properties: Optional[Dict[str, Any]] = None) -> bool:
    """Track feature usage"""
    client = get_posthog_client()
...
async def track_page_view(user_id: str, page_name: str, properties: Optional[Dict[str, Any]] = None) -> bool:
    """Track page view"""
    client = get_posthog_client()
...
async def track_error(user_id: str, error_type: str, error_message: str, properties: Optional[Dict[str, Any]] = None) -> bool:
