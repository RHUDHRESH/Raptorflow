...
class SimpleResearchReport:
    ...
    def from_research_report(cls, report) -> "SimpleResearchReport":
        ...
        simple_sources = [SimpleSearchResult.from_search_result(s) for s in report.sources]
...
class UnifiedSearchInterface:
    ...
    async def search(self, request: SimpleSearchRequest) -> List[SimpleSearchResult]:
        ...
        try:
            ...
            simple_results = [SimpleSearchResult.from_search_result(r) for r in consolidated_results]
    ...
    async def research(self, request: SimpleResearchRequest) -> SimpleResearchReport:
        ...
        try:
            ...
            logger.info(f"Research completed: {len(simple_report.key_findings)} findings")
    ...
    async def quick_search(self, query: str, max_results: int = 5) -> List[SimpleSearchResult]:
    ...
    async def comprehensive_search(self, query: str, max_results: int = 20) -> List[SimpleSearchResult]:
    ...
    async def news_search(self, query: str, max_results: int = 10, time_range: str = "1w") -> List[SimpleSearchResult]:
    ...
    async def academic_search(self, query: str, max_results: int = 15) -> List[SimpleSearchResult]:
    ...
    async def exhaustive_research(self, topic: str, question: str) -> SimpleResearchReport:
...
async def search(query: str, mode: str = "standard", max_results: int = 10) -> List[SimpleSearchResult]:
...
async def research(topic: str, question: str, depth: str = "moderate") -> SimpleResearchReport:
