...
from core.enhanced_exceptions import (
    ValidationError as RaptorValidationError,
...
class ValidationResult:
    ...
    def add_issue(self, field: str, message: str, severity: ValidationSeverity, code: str, value: Any, constraint: Optional[str] = None):
...
class EnhancedValidator:
    ...
    def validate_date_range(self, value: date, min_date: Optional[date] = None, max_date: Optional[date] = None) -> bool:
    ...
    def validate_string_length(self, value: str, min_length: Optional[int] = None, max_length: Optional[int] = None) -> bool:
    ...
    def validate_numeric_range(self, value: Union[int, float], min_value: Optional[Union[int, float]] = None, max_value: Optional[Union[int, float]] = None) -> bool:
    ...
    def validate_model(self, model_class: Type[BaseModel], data: Dict[str, Any]) -> ValidationResult:
        ...
        try:
            ...
            for error in e.errors():
                ...
                elif code in ['string_too_short', 'string_too_long', 'greater_than', 'less_than']:
    ...
    def _run_custom_validators(self, model_class: Type[BaseModel], data: Dict[str, Any], result: ValidationResult):
    ...
    def _run_global_constraints(self, model_class: Type[BaseModel], data: Dict[str, Any], result: ValidationResult):
...
class EnhancedBaseModel(BaseModel):
    ...
    def validate_with_enhanced_validator(self, validator: EnhancedValidator) -> ValidationResult:
        """Validate model with enhanced validator."""
        return validator.validate_model(self.__class__, self.model_dump())
    
    @classmethod
    def validate_data(cls, data: Dict[str, Any], validator: Optional[EnhancedValidator] = None) -> ValidationResult:
...
def get_enhanced_validator() -> EnhancedValidator:
    ...
    if _enhanced_validator is None:
        ...
        _enhanced_validator.add_validator("future_date", CommonValidators.future_date_validator)
        _enhanced_validator.add_validator("past_date", CommonValidators.past_date_validator)
        _enhanced_validator.add_validator("positive_number", CommonValidators.positive_number_validator)
        _enhanced_validator.add_validator("non_empty_string", CommonValidators.non_empty_string_validator)
...
def handle_pydantic_validation_error(error: ValidationError, context: Optional[str] = None) -> RaptorValidationError:
