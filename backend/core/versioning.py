...
class APIVersionManager:
    ...
    def is_version_supported(self, version: str) -> bool:
        ...
        return version in self.versions and not self.versions[version].get("removed", False)
    
    def is_version_deprecated(self, version: str) -> bool:
        """Check if a version is deprecated."""
        return version in self.versions and self.versions[version].get("deprecated", False)
