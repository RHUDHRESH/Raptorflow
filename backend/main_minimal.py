...
def build_health_payload():
    return {
        ...
        "services": {"api": "running", "database": "mock", "redis": "mock"},
    }
...
async def contradictions(session_id: str, request: Dict[str, Any]):
    return {
        ...
        "contradictions": [
            {
                "id": "C-001",
                "description": "Feature X conflicts with pricing model",
                "severity": "medium",
            },
            {
                "id": "C-002",
                "description": "Target audience mismatch",
                "severity": "high",
            },
        ],
    }
    ...
    return {
        ...
        "truth_sheet": {
            "statements": [
                {
                    "id": "T-001",
                    "statement": "We help companies scale faster",
                    "confidence": 0.85,
                },
                {
                    "id": "T-002",
                    "statement": "Our solution reduces costs by 40%",
                    "confidence": 0.72,
                },
            ]
        },
...
async def focus_sacrifice(session_id: str, request: Dict[str, Any]):
    return {
        ...
        "focus_sacrifice": {
            "focus_items": [
                {
                    "description": "Focus on primary ICP segment",
                    "category": "audience",
                    "impact": 0.9,
                }
            ],
            "sacrifice_items": [
                {
                    "description": "Sacrifice enterprise market",
                    "category": "market",
                    "impact": 0.7,
                }
            ],
            ...
            "library": [
                {
                    "id": "SND-001",
                    "type": "tagline",
                    "content": "Better results without the complexity",
                }
            ]
        },
    }
