...
class SentryMiddleware(BaseHTTPMiddleware):
    ...
    def _extract_response_info(
        self, response: Response, response_time_ms: float
    ) -> Dict[str, Any]:
    ...
    def _setup_sentry_context(
        self, request: Request, request_info: Dict[str, Any], session_id: Optional[str]
    ) -> None:
        ...
        try:
            ...
            configure_scope(
                lambda scope: set_tag("http.method", request_info["method"])
            )
            ...
            if self.capture_headers and "headers" in request_info:
                ...
                filtered_headers = self._filter_sensitive_headers(
        ...
        try:
            ...
            self.performance_monitor.track_api_request(
                ...
                response_size_bytes=int(
                    response_info.get("content_length", "0") or "0"
                ),
