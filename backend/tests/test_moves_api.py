...
def test_generate_moves_endpoint_success():
    ...
    mock_service.generate_weekly_moves = AsyncMock(return_value={"status": "started", "campaign_id": "test-id"})
...
def test_get_moves_status_endpoint():
    ...
    mock_service = MagicMock()
    mock_service.get_moves_generation_status = AsyncMock(return_value={"status": "execution", "messages": []})
