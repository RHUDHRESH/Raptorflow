...
async def test_sanity_check_all_pass():
    ...
    with patch("backend.services.sanity_check.get_cache", return_value=mock_redis), \
         patch("backend.services.sanity_check.get_db_connection", return_value=mock_db_cm), \
