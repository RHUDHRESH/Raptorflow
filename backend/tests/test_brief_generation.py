...
from backend.agents.specialists.campaign_planner import CampaignArcOutput, MonthlyArc, StrategicMilestone
...
def test_brief_generation_logic():
    ...
    arc = CampaignArcOutput(
        ...
        monthly_arcs=[MonthlyArc(month_number=1, theme="Foundations", milestones=[StrategicMilestone(title="BK", description="Ext", target_kpi="Done")])],
