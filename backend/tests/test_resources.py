...
class TestResourceManager:
    ...
    async def test_register_resource(self, resource_manager):
        ...
        assert resource_manager.resources[resource_id].resource_type == ResourceType.MEMORY
    ...
    async def test_unregister_resource(self, resource_manager):
        ...
        assert resource_manager.resources[resource_id].status == ResourceStatus.CLEANED_UP
    ...
    async def test_quota_enforcement(self, resource_manager):
        ...
        assert resource_manager.register_resource(
            "quota_test_1",
            ResourceType.MEMORY,
            workspace_id="test_workspace"
        ) is True
    ...
    async def test_cleanup_by_type(self, resource_manager):
        ...
        resource_manager.register_resource("cleanup_test_1", ResourceType.MEMORY, owner="test_user")
        resource_manager.register_resource("cleanup_test_2", ResourceType.FILE_HANDLE, owner="test_user")
        resource_manager.register_resource("cleanup_test_3", ResourceType.MEMORY, owner="test_user")
        
        # Clean up memory resources
        cleanup_count = await resource_manager.cleanup_resources_by_type(ResourceType.MEMORY)
    ...
    async def test_cleanup_by_owner(self, resource_manager):
        ...
        resource_manager.register_resource("owner_test_1", ResourceType.MEMORY, owner="user1")
        resource_manager.register_resource("owner_test_2", ResourceType.FILE_HANDLE, owner="user1")
        resource_manager.register_resource("owner_test_3", ResourceType.MEMORY, owner="user2")
    ...
    async def test_resource_summary(self, resource_manager):
        ...
        resource_manager.register_resource("summary_test_1", ResourceType.MEMORY, owner="user1")
        resource_manager.register_resource("summary_test_2", ResourceType.FILE_HANDLE, owner="user1")
        resource_manager.register_resource("summary_test_3", ResourceType.MEMORY, owner="user2", status=ResourceStatus.LEAKED)
...
class TestResourceLeaks:
    ...
    async def test_leak_creation(self):
        ...
        from backend.core.resources import ResourceLeak
