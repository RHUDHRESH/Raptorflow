...
class TestAuthentication:
    ...
    def test_change_password(self, client: TestClient, test_user_data: Dict[str, Any]):
        ...
        response = client.post("/api/v1/auth/change-password", json=data, headers=headers)
    ...
    def test_protected_endpoint_with_token(self, client: TestClient, test_user_data: Dict[str, Any]):
    ...
    def test_session_management(self, client: TestClient, test_user_data: Dict[str, Any]):
    ...
    def test_user_profile_update(self, client: TestClient, test_user_data: Dict[str, Any]):
    ...
    def test_concurrent_login_attempts(self, client: TestClient, test_user_data: Dict[str, Any]):
    ...
    def test_token_storage_security(self, client: TestClient, test_user_data: Dict[str, Any]):
    ...
    def test_account_lockout(self, client: TestClient):
        ...
        final_response = client.post("/api/v1/auth/login", json={
            "email": "test@example.com",
