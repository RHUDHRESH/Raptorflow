...
from backend.agents.specialists.goal_aligner import GoalAlignerAgent, GoalAlignmentOutput, InputMetric
...
async def test_goal_alignment_logic():
    ...
    expected_alignment = GoalAlignmentOutput(
        ...
        input_metrics=[InputMetric(name="Lead Volume", description="Top of funnel", target_value="500", control_lever="Ad Spend")],
