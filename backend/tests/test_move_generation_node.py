...
from backend.agents.specialists.move_generator import MoveGeneratorAgent, MovePacketOutput, WeeklyMove, ActionItem
    ...
    expected_packet = MovePacketOutput(
        ...
        moves=[
            WeeklyMove(
                ...
                action_items=[ActionItem(task="Run extraction", owner="researcher", tool_requirements=["Firecrawl"])],
