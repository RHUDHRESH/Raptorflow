...
try:
    ...
    from backend.agents.specialists.social_media_agent import SocialMediaAgent
    print("DEBUG: Imported SocialMediaAgent")
    from backend.agents.specialists.competitor_intel import CompetitorIntelAgent
