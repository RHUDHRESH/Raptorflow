...
from core.enhanced_validation import EnhancedBaseModel, CommonValidators, get_enhanced_validator
...
def test_enhanced_brand_positioning_validation():
    ...
    assert result.is_valid, f"Valid data failed validation: {[issue.message for issue in result.get_errors()]}"
