...
from backend.memory.knowledge_graph import KnowledgeGraphConnector
...
async def test_kg_add_concept():
    ...
    with patch("backend.memory.knowledge_graph.get_db_connection", return_value=mock_get_db):
