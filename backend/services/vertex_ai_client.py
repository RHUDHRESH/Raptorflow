...
class VertexAIClient:
    ...
    def _sanitize_input(self, text: str) -> str:
        ...
        forbidden = ["ignore all previous instructions", "ignore previous instructions", "you are now an admin", "system override"]
    ...
    async def generate_text_with_context(self, prompt: str, context: str, model: Optional[str] = None) -> Optional[str]:
    ...
    async def analyze_text(self, text: str, analysis_type: str = "sentiment") -> Optional[Dict[str, Any]]:
