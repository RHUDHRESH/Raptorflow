...
class MoveService:
    ...
    async def generate_weekly_moves(self, campaign_id: str) -> Optional[dict]:
        ...
        initial_state = {
            ...
            "status": "monitoring",
            "messages": [f"Triggering weekly move generation for campaign: {campaign.title}"]
        }
    ...
    async def update_move_status(self, move_id: str, status: str, result: Optional[dict] = None):
