...
class MoveService(BaseService):
    ...
    def _map_ui_goal_to_db(self, ui_goal: Optional[str], ui_category: Optional[str]) -> str:
        ...
        def _execute():
            ...
            for row in result.data or []:
                ...
                if isinstance(ui_move, dict):
                    ...
                    ui_move.setdefault("createdAt", row.get("created_at") or self._now_iso())
    ...
    def create_move(self, workspace_id: str, move_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        def _execute():
            ...
            db_row = {
                ...
                "goal": self._map_ui_goal_to_db(move_data.get("goal"), move_data.get("category")),
    ...
    def update_move(self, workspace_id: str, move_id: str, patch_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        def _execute():
            ...
            db_update = {
                ...
                "goal": self._map_ui_goal_to_db(updated_ui.get("goal"), updated_ui.get("category")),
