...
class UniversalExtractor:
    ...
    async def extract(self, file_content: bytes, file_type: str, **kwargs) -> OCRResponse:
        """
        ...
        final_response = await self.cognitive_layer.cleanup(raw_response, context=kwargs.get("context"))
