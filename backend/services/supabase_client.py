...
class SupabaseClient:
    ...
    async def update_workspace(self, workspace_id: str, workspace_data: Dict[str, Any]) -> Dict[str, Any]:
        """Update workspace data"""
        try:
            result = await self.update_data("workspaces", workspace_data, {"id": workspace_id})
            return result
        except Exception as e:
    ...
    async def get_workspace_users(self, workspace_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            result = await self.select_data("workspace_users", {"workspace_id": workspace_id})
            return result.get("data", [])
        except Exception as e:
            logger.error(f"Failed to get workspace users: {e}")
            return []
    
    async def add_user_to_workspace(self, workspace_id: str, user_id: str, role: str = "member") -> Dict[str, Any]:
    ...
    async def remove_user_from_workspace(self, workspace_id: str, user_id: str) -> Dict[str, Any]:
        """Remove user from workspace"""
        try:
            result = await self.delete_data("workspace_users", {"workspace_id": workspace_id, "user_id": user_id})
            return result
        except Exception as e:
