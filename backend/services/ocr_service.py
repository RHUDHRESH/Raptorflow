...
from .services.ocr.universal_extractor import UniversalExtractor as HybridOCRExtractor
    ...
    def __init__(self):
        ...
        async def extract_text(self, document: DocumentMetadata) -> OCRResult:
            ...
            try:
                ...
                from services.document_service import GCPStorageManager
        ...
        async def extract_text_from_bytes(
            self, file_content: bytes, file_type: str, document_id: str = "temp"
        ) -> OCRResult:
            """
