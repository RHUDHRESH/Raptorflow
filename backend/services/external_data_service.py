...
class MarketResearchAPI:
    ...
    async def get_industry_trends(self, industry: str, timeframe: str = "1year") -> List[Dict]:
        """Get industry trends."""
        try:
            session = await self._get_session()
...
class NewsAPIService:
    ...
    async def search_news(self, query: str, limit: int = 10, timeframe: str = "7days") -> List[Dict]:
        ...
        try:
            ...
            if business_data.get('industry'):
                market_data = await self.market_research.get_market_size(
                    ...
                    business_data.get('geography', 'global')
                )
                ...
                if market_data:
                    ...
                    added_fields.extend(['market_tam', 'market_sam', 'market_som', 'market_growth_rate'])
            ...
            if business_data.get('industry'):
                ...
                if competitors:
                    ...
                    sources_used.append('market_research_api')
                    confidence_scores.append(0.7)  # Medium confidence for competitor data
            ...
            if business_data.get('industry'):
                ...
                if benchmarks:
                    ...
                    added_fields.extend(['industry_profit_margin', 'industry_revenue_growth', 'industry_debt_ratio'])
                    sources_used.append('financial_data_api')
                    confidence_scores.append(0.75)  # Medium-high confidence for benchmarks
            ...
            if business_data.get('country'):
                ...
                if gdp_data:
                    ...
                    enriched_data['country_gdp_growth'] = gdp_data.get('growth_rates', [])
...
class ExternalDataService:
    ...
    async def get_market_intelligence(self, business_data: Dict) -> Dict:
        ...
        try:
            ...
            return {
                ...
                'data_quality_score': await self._assess_data_quality(enrichment_result.enriched_data),
    ...
    async def _generate_market_insights(self, enriched_data: Dict, sources_used: List[str]) -> Dict:
        """Generate market insights using LLM."""
        try:
    ...
    async def _assess_data_quality(self, data: Dict) -> float:
        ...
        completeness = sum(1 for field in required_fields if field in data and data[field])
