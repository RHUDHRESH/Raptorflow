...
class BCMService(BaseService):
    ...
    def get_by_version(self, workspace_id: str, version: int) -> Optional[Dict[str, Any]]:
...
def store_manifest(workspace_id: str, manifest: Dict[str, Any], source_context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
def seed_from_business_context(workspace_id: str, business_context: Dict[str, Any]) -> Dict[str, Any]:
    return bcm_service.seed_from_business_context(workspace_id, business_context)

async def seed_from_business_context_async(workspace_id: str, business_context: Dict[str, Any]) -> Dict[str, Any]:
    return await bcm_service.seed_from_business_context_async(workspace_id, business_context)
