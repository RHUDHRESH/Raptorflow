...
class EnvironmentConfig(BaseModel):
    ...
    # CORS
    CORS_ORIGIN: str = "https://raptorflow.com,https://www.raptorflow.com,https://app.raptorflow.com"
...
class EnvironmentManager:
    ...
    def _get_all_env_vars(self) -> Dict[str, Any]:
        ...
        boolean_vars = [
            'HEALTH_CHECK_ENABLED', 'CORS_CREDENTIALS', 'SECURITY_FRAME_DENY',
            'FEATURE_AUTHENTICATION', 'FEATURE_PASSWORD_RESET', 'FEATURE_SOCIAL_LOGIN',
            'FEATURE_WORKSPACES', 'FEATURE_ANALYTICS', 'FEATURE_MONITORING',
            'FEATURE_RATE_LIMITING', 'FEATURE_EMAIL_NOTIFICATIONS', 'COMPRESSION_ENABLED',
            'CACHE_ENABLED', 'BACKUP_ENABLED', 'MAINTENANCE_MODE'
        ]
        ...
        integer_vars = [
            'PORT', 'SESSION_MAX_AGE', 'RATE_LIMIT_ANONYMOUS', 'RATE_LIMIT_AUTHENTICATED',
            'RATE_LIMIT_ADMIN', 'HEALTH_CHECK_INTERVAL', 'PHONEPE_CLIENT_VERSION',
            'DATABASE_POOL_MIN', 'DATABASE_POOL_MAX', 'DATABASE_POOL_IDLE_TIMEOUT',
            'COMPRESSION_LEVEL', 'CACHE_TTL', 'CACHE_MAX_SIZE', 'BACKUP_RETENTION_DAYS'
        ]
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'message': 'All required environment variables are set' if not missing_vars else f'Missing required variables: {", ".join(missing_vars)}'
            }
        except Exception as e:
            return {
                'status': 'unhealthy',
