...
class UpstashClient:
    ...
    async def set_bcm(self, workspace_id: str, manifest: Dict[str, Any], version: int, ttl: int = 86400) -> bool:
        """
    ...
    async def get_bcm_version(self, workspace_id: str, version: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Failed to get BCM version {version} for workspace {workspace_id}: {e}")
            return None
