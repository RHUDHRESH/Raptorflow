...
class PaymentStatusService:
    ...
    async def check_payment_statuses(self, transaction_ids: List[str]) -> Dict[str, Dict]:
    ...
    async def check_payment_status(self, transaction_id: str) -> Dict[str, Optional[str]]:
        ...
        try:
            ...
            return {"status": response.status, "last_checked": datetime.now().isoformat()}
