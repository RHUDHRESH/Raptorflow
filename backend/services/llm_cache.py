...
class LLMSemanticCache:
            ...
            if semantic_results:
                ...
                for cached_query, cached_data in semantic_results.items():
                    ...
                    if similarity >= self.similarity_threshold:
                        ...
                        await self.redis.set_json(semantic_key, semantic_results, ex=self.cache_ttl)
    ...
    async def cache_response(
        ...
        try:
            ...
            await self.redis.set_json(semantic_key, existing_semantic, ex=self.cache_ttl)
    ...
    async def get_cache_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            total_hits = sum(
                ...
                for entry in global_index.values()
            )
            stats['total_hits'] = total_hits
            stats['average_hits_per_entry'] = total_hits / len(global_index) if global_index else 0
