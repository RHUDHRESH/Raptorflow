...
from .models import (
    OCRProcessingResponse, BatchProcessingResponse,
    DocumentAnalysisResponse, ModelPerformanceResponse
)
...
class OCRProcessingOptions(BaseModel):
    ...
    strategy: Optional[str] = Field(None, description="Processing strategy: 'ensemble', 'single', 'auto'")
    ...
    enable_structured_data: Optional[bool] = Field(True, description="Extract structured data")


class BatchOCRRequest(BaseModel):
    """Request for batch OCR processing."""
    documents: List[Dict[str, Any]] = Field(..., description="List of documents with file_data and filename")
    options: Optional[OCRProcessingOptions] = Field(None, description="Processing options")
...
async def get_system_status(service: SOTAOCRService = Depends(get_ocr_service)):
    ...
    try:
        ...
        return SystemStatusResponse(
            ...
            active_models=["dots_ocr", "olm_ocr_2_7b", "chandra_ocr_8b", "deepseek_ocr_3b", "lighton_ocr"]
        )
    ...
    try:
        models = {
            "chandra_ocr_8b": {
                ...
                "languages": ["eng", "chi_sim", "spa", "fra", "deu", "jpn", "kor", "ara", "hin", "rus", "por", "ita", "tur", "pol", "nld"],
                "max_resolution": 4000,
                "gpu_memory_gb": 16,
                "license": "open_source"
            },
            "olm_ocr_2_7b": {
                ...
                "languages": ["eng", "chi_sim", "spa", "fra", "deu", "jpn", "kor", "ara", "hin", "rus", "por", "ita", "tur", "pol", "nld", "tha", "vie", "ind", "heb", "ben", "tam", "tel", "mar"],
                "max_resolution": 3000,
                "gpu_memory_gb": 12,
                "license": "open_source"
            },
            "dots_ocr": {
                ...
                "languages": ["eng", "chi_sim", "chi_tra", "spa", "fra", "deu", "jpn", "kor", "ara", "hin", "rus", "por", "ita", "tur", "pol", "nld", "tha", "vie", "ind", "heb", "ben", "tam", "tel", "mar", "guj", "kan", "mal", "ori", "pun", "urd", "mya", "khm", "lao", "sin", "tib"],
                "max_resolution": 2000,
                "gpu_memory_gb": 8,
                "license": "commercial"
            },
...
async def test_ocr_processing(
    ...
    try:
        ...
        # Process document
        result = await service.process_document(file_data, file.filename, {"strategy": "auto"})
