...
from backend.schemas import BusinessContextState, MessagingStrategy
...
class BusinessContextGenerator:
    ...
    async def generate_from_foundation(self, foundation_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if context.messaging_strategy:
                await self.messaging_repo.upsert(workspace_id, context.messaging_strategy.model_dump())
    ...
    async def enhance_icp_context(self, icp_data: Dict[str, Any], foundation_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def generate_messaging_strategy(self, business_context: Dict[str, Any], icp_data: List[Dict[str, Any]]) -> Dict[str, Any]:
