...
async def test_phonepe_gateway():
    ...
    try:
        ...
        from services.phonepe_sdk_gateway_fixed import PaymentRequest
        ...
        try:
            ...
            print(f"   ⚠️  Client Init Failed (expected with test credentials): {str(e)}")
        
        print("\n🎉 PhonePe SDK Gateway Test Complete!")
        print("📋 Status: ✅ Gateway code working, needs real credentials for API calls")
        
        return True
        
    except ImportError as e:
        print(f"❌ Import Error: {e}")
        print("📋 Fix: Ensure phonepe-sdk-python is installed: pip install phonepe-sdk-python==3.2.1")
        return False
