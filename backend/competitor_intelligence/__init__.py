...
from .monitoring import CompetitorMonitoringService, CompetitorAnalysisService
...
class CompetitorIntelligenceManager:
    ...
    async def start_monitoring(self, competitor_ids: List[str], frequency: str = "daily"):
