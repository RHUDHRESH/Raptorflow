...
class MarketTrendSignal(BaseModel):
    ...
    signal_evidence: str = Field(description="The core evidence or 'why' behind the trend.")
...
class ResearchOutput(BaseModel):
    ...
    competitor_blind_spots: List[str] = Field(description="What competitors are ignoring.")
