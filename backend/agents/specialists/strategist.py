...
class PositioningOutput(BaseModel):
    ...
    contrarian_truth: str = Field(description="The non-obvious truth about the category.")
    job_to_be_done: str = Field(description="The specific functional/emotional job the user is hiring the product for.")
    category_of_one: str = Field(description="The new category name where the product has no competition.")
    uvp_statement: str = Field(description="The 100% surgical Unique Value Proposition.")
