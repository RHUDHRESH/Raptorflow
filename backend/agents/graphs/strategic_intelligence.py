...
from backend.agents.specialists.strategic_director import StrategicDirector
...
class StrategicIntelligenceGraph:
    ...
    def _build_graph(self) -> StateGraph:
        ...
        builder.add_conditional_edges(
            ...
            {
                "strategy": "strategy", # Send back for revision if rejected
                END: END
            }
        )
    ...
    async def research_node(self, state: StrategicIntelligenceState) -> StrategicIntelligenceState:
    ...
    async def strategy_node(self, state: StrategicIntelligenceState) -> StrategicIntelligenceState:
    ...
    async def creation_node(self, state: StrategicIntelligenceState) -> StrategicIntelligenceState:
    ...
    async def director_node(self, state: StrategicIntelligenceState) -> StrategicIntelligenceState:
    ...
    def should_continue_from_research(self, state: StrategicIntelligenceState) -> str:
        ...
        if state.get("research_data") and len(state["research_data"].get("key_findings", [])) > 0:
            return "strategy"
