...
def check_frontend_integration():
    ...
    frontend_path = os.path.join(
        os.getcwd(), "raptorflow-app/src/components/moves/MoveToolbeltView.tsx"
    )
...
def check_agent_integration():
    ...
    tool_integration_path = os.path.join(
        os.getcwd(), "backend/agents/tool_integration.py"
    )
...
def run_direct_validation():
    ...
    print(
        f"Specialist agents updated: {agent_check['specialist_agents_updated']}/{agent_check['total_specialist_files']}"
    )
    print()
